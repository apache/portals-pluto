 ...
 */
public class SigTestsEvent_PortletResponse_SIGEvent_event implements Portlet, EventPortlet, ResourceServingPortlet {
   ...
   public void processEvent(EventRequest portletReq, EventResponse portletResp)
      ...
      /* "                                                                    */
      TestResult tr0 = tcd.getTestResultFailed(V2SIGTESTSEVENT_PORTLETRESPONSE_SIGEVENT_HASADDPROPERTY);
      try {
      ...
      TestResult tr1 = tcd.getTestResultFailed(V2SIGTESTSEVENT_PORTLETRESPONSE_SIGEVENT_HASADDPROPERTYA);
      try {
         String name = "addProperty";
         Class<?>[] exceptions = null;
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2SIGTESTSEVENT_PORTLETRESPONSE_SIGEVENT_HASADDPROPERTYB);
      try {
         String name = "addProperty";
         Class<?>[] exceptions = null;
      ...
      /* void "                                                               */
      TestResult tr3 = tcd.getTestResultFailed(V2SIGTESTSEVENT_PORTLETRESPONSE_SIGEVENT_HASADDPROPERTYRETURNS);
      try {
         String name = "addProperty";
      ...
      TestResult tr4 = tcd.getTestResultFailed(V2SIGTESTSEVENT_PORTLETRESPONSE_SIGEVENT_HASADDPROPERTYRETURNSA);
      try {
         String name = "addProperty";
         Class<?> retType = void.class;
         Class<?>[] parms = {javax.servlet.http.Cookie.class};
      ...
      TestResult tr5 = tcd.getTestResultFailed(V2SIGTESTSEVENT_PORTLETRESPONSE_SIGEVENT_HASADDPROPERTYRETURNSB);
      try {
         String name = "addProperty";
         Class<?> retType = void.class;
         Class<?>[] parms = {String.class, org.w3c.dom.Element.class};
      ...
      TestResult tr6 = tcd.getTestResultFailed(V2SIGTESTSEVENT_PORTLETRESPONSE_SIGEVENT_HASCREATEELEMENT);
      try {
      ...
      /* org.w3c.dom.Element "                                                */
      TestResult tr7 = tcd.getTestResultFailed(V2SIGTESTSEVENT_PORTLETRESPONSE_SIGEVENT_HASCREATEELEMENTRETURNS);
      try {
         String name = "createElement";
      ...
      TestResult tr9 = tcd.getTestResultFailed(V2SIGTESTSEVENT_PORTLETRESPONSE_SIGEVENT_HASENCODEURLRETURNS);
      try {
         String name = "encodeURL";
      ...
      TestResult tr10 = tcd.getTestResultFailed(V2SIGTESTSEVENT_PORTLETRESPONSE_SIGEVENT_HASGETNAMESPACE);
      try {
      ...
      TestResult tr11 = tcd.getTestResultFailed(V2SIGTESTSEVENT_PORTLETRESPONSE_SIGEVENT_HASGETNAMESPACERETURNS);
      try {
         String name = "getNamespace";
         Class<?> retType = String.class;
         Class<?>[] parms = null;
      ...
      /* "                                                                    */
      TestResult tr12 = tcd.getTestResultFailed(V2SIGTESTSEVENT_PORTLETRESPONSE_SIGEVENT_HASSETPROPERTY);
      try {
      ...
      /* void "                                                               */
      TestResult tr13 = tcd.getTestResultFailed(V2SIGTESTSEVENT_PORTLETRESPONSE_SIGEVENT_HASSETPROPERTYRETURNS);
      try {
         String name = "setProperty";
         Class<?> retType = void.class;
         Class<?>[] parms = {String.class, String.class};
      ...
      portletReq.getPortletSession().setAttribute(
                   Constants.RESULT_ATTR_PREFIX + "SigTestsEvent_PortletResponse_SIGEvent",
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      String msg = (String) portletReq.getPortletSession()
            .getAttribute(RESULT_ATTR_PREFIX + "SigTestsEvent_PortletResponse_SIGEvent", APPLICATION_SCOPE);
