 ...
 * portlet SigTestsRender_MimeResponse_SIGRender_event
 *
 */
public class SigTestsRender_MimeResponse_SIGRender implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsRender_MimeResponse_SIGRender.class.getName();
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      TestResult tr0 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_FIELDCACHE_SCOPE);
      try {
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_FIELDEXPIRATION_CACHE);
      try {
      ...
      TestResult tr3 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_FIELDMARKUP_HEAD_ELEMENT);
      try {
      ...
      TestResult tr4 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_FIELDNAMESPACED_RESPONSE);
      try {
      ...
      TestResult tr5 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_FIELDPRIVATE_SCOPE);
      try {
      ...
      TestResult tr6 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_FIELDPUBLIC_SCOPE);
      try {
      ...
      TestResult tr7 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_FIELDUSE_CACHED_CONTENT);
      try {
      ...
      TestResult tr8 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASCREATEACTIONURL);
      try {
      ...
      /* PortletURL "                                                         */
      TestResult tr9 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASCREATEACTIONURLRETURNS);
      try {
         String name = "createActionURL";
      ...
      TestResult tr10 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASCREATERENDERURL);
      try {
      ...
      /* PortletURL "                                                         */
      TestResult tr11 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASCREATERENDERURLRETURNS);
      try {
         String name = "createRenderURL";
         Class<?> retType = PortletURL.class;
         Class<?>[] parms = null;
      ...
      TestResult tr12 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASCREATERESOURCEURL);
      try {
      ...
      /* ResourceURL "                                                        */
      TestResult tr13 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASCREATERESOURCEURLRETURNS);
      try {
         String name = "createResourceURL";
      ...
      TestResult tr14 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASFLUSHBUFFER);
      try {
      ...
      TestResult tr15 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASFLUSHBUFFERRETURNS);
      try {
         String name = "flushBuffer";
      ...
      TestResult tr16 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASGETBUFFERSIZE);
      try {
      ...
      TestResult tr17 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASGETBUFFERSIZERETURNS);
      try {
         String name = "getBufferSize";
      ...
      TestResult tr18 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASGETCACHECONTROL);
      try {
      ...
      /* CacheControl "                                                       */
      TestResult tr19 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASGETCACHECONTROLRETURNS);
      try {
         String name = "getCacheControl";
      ...
      TestResult tr20 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASGETCHARACTERENCODING);
      try {
      ...
      /* String "                                                             */
      TestResult tr21 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASGETCHARACTERENCODINGRETURNS);
      try {
         String name = "getCharacterEncoding";
      ...
      TestResult tr22 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASGETCONTENTTYPE);
      try {
      ...
      TestResult tr23 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASGETCONTENTTYPERETURNS);
      try {
         String name = "getContentType";
         Class<?> retType = String.class;
         Class<?>[] parms = null;
      ...
      /* java.util.Locale "                                                   */
      TestResult tr25 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASGETLOCALERETURNS);
      try {
         String name = "getLocale";
      ...
      TestResult tr26 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASGETPORTLETOUTPUTSTREAM);
      try {
      ...
      TestResult tr27 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASGETPORTLETOUTPUTSTREAMRETURNS);
      try {
         String name = "getPortletOutputStream";
      ...
      /* java.io.PrintWriter "                                                */
      TestResult tr29 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASGETWRITERRETURNS);
      try {
         String name = "getWriter";
      ...
      TestResult tr30 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASISCOMMITTED);
      try {
      ...
      TestResult tr31 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASISCOMMITTEDRETURNS);
      try {
         String name = "isCommitted";
      ...
      TestResult tr33 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASRESETBUFFER);
      try {
      ...
      TestResult tr34 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASRESETBUFFERRETURNS);
      try {
         String name = "resetBuffer";
         Class<?> retType = void.class;
         Class<?>[] parms = null;
      ...
      TestResult tr35 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASRESETRETURNS);
      try {
         String name = "reset";
         Class<?> retType = void.class;
         Class<?>[] parms = null;
      ...
      TestResult tr36 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASSETBUFFERSIZE);
      try {
      ...
      TestResult tr37 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASSETBUFFERSIZERETURNS);
      try {
         String name = "setBufferSize";
         Class<?> retType = void.class;
         Class<?>[] parms = {int.class};
      ...
      TestResult tr38 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASSETCONTENTTYPE);
      try {
      ...
      /* void "                                                               */
      TestResult tr39 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_HASSETCONTENTTYPERETURNS);
      try {
         String name = "setContentType";
         Class<?> retType = void.class;
         Class<?>[] parms = {String.class};
      ...
      TestResult tr40 = tcd.getTestResultFailed(V2SIGTESTSRENDER_MIMERESPONSE_SIGRENDER_IMPLEMENTSPORTLETRESPONSE);
      try {
