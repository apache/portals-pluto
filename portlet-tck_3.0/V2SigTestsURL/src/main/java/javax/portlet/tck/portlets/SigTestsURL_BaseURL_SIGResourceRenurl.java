 ...
 * portlet SigTestsURL_BaseURL_SIGResourceRenurl_event
 *
 */
public class SigTestsURL_BaseURL_SIGResourceRenurl implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsURL_BaseURL_SIGResourceRenurl.class.getName();
   ...
   public void serveResource(ResourceRequest portletReq, ResourceResponse portletResp)
      ...
      TestResult tr0 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERENURL_HASADDPROPERTY);
      try {
      ...
      /* void "                                                               */
      TestResult tr1 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERENURL_HASADDPROPERTYRETURNS);
      try {
         String name = "addProperty";
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERENURL_HASGETPARAMETERMAP);
      try {
      ...
      /* java.util.Map "                                                      */
      TestResult tr3 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERENURL_HASGETPARAMETERMAPRETURNS);
      try {
         String name = "getParameterMap";
      ...
      TestResult tr4 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERENURL_HASSETPARAMETER);
      try {
      ...
      /* Details: "Render URL has a setParameter(String, String[])  method    */
      /* "                                                                    */
      TestResult tr5 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERENURL_HASSETPARAMETERA);
      try {
         String name = "setParameter";
         Class<?>[] exceptions = null;
         Class<?>[] parms = {String.class, String[].class};
      ...
      /* void "                                                               */
      TestResult tr6 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERENURL_HASSETPARAMETERRETURNS);
      try {
         String name = "setParameter";
         Class<?> retType = void.class;
         Class<?>[] parms = {String.class, String.class};
      ...
      /* Details: "Render URL method setParameter(String, String[]) returns   */
      /* void "                                                               */
      TestResult tr7 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERENURL_HASSETPARAMETERRETURNSA);
      try {
         String name = "setParameter";
         Class<?> retType = void.class;
         Class<?>[] parms = {String.class, String[].class};
      ...
      TestResult tr8 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERENURL_HASSETPARAMETERS);
      try {
      ...
      /* void "                                                               */
      TestResult tr9 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERENURL_HASSETPARAMETERSRETURNS);
      try {
         String name = "setParameters";
         Class<?> retType = void.class;
         Class<?>[] parms = {java.util.Map.class};
      ...
      TestResult tr10 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERENURL_HASSETPROPERTY);
      try {
      ...
      /* void "                                                               */
      TestResult tr11 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERENURL_HASSETPROPERTYRETURNS);
      try {
         String name = "setProperty";
         Class<?> retType = void.class;
         Class<?>[] parms = {String.class, String.class};
      ...
      TestResult tr13 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERENURL_HASSETSECURERETURNS);
      try {
         String name = "setSecure";
         Class<?> retType = void.class;
         Class<?>[] parms = {boolean.class};
      ...
      TestResult tr15 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERENURL_HASTOSTRINGRETURNS);
      try {
         String name = "toString";
      ...
      TestResult tr18 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERENURL_HASWRITERETURNS);
      try {
         String name = "write";
         Class<?> retType = void.class;
         Class<?>[] parms = {java.io.Writer.class};
      ...
      /* void "                                                               */
      TestResult tr19 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERENURL_HASWRITERETURNSA);
      try {
         String name = "write";
         Class<?> retType = void.class;
         Class<?>[] parms = {java.io.Writer.class, boolean.class};
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      writer.write("         document.getElementById(\"SigTestsURL_BaseURL_SIGResourceRenurl\").innerHTML=xhr.responseText;\n");
      writer.write("      }\n");
      writer.write("   };\n");
