...
<%
      ...
      TestResult tr1 = tcd.getTestResultFailed(V2DISPATCHERTESTS3S_SPEC2_19_FORWARDJSPEVENT_INVOKE3);
      /* TODO: implement test */
      tr1.appendTcDetail("Not implemented.");
      tr1.writeTo(writer);

      request.getSession().setAttribute(
                   Constants.RESULT_ATTR_PREFIX + "DispatcherTests3S_SPEC2_19_ForwardJSPEvent",
                   writer.toString());
%>
