 ...
 * portlet SigTestsResource_ClientDataRequest_SIGResource_event
 *
 */
public class SigTestsResource_ClientDataRequest_SIGResource implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsResource_ClientDataRequest_SIGResource.class.getName();
   ...
   public void serveResource(ResourceRequest portletReq, ResourceResponse portletResp)
      ...
      TestResult tr0 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_CLIENTDATAREQUEST_SIGRESOURCE_HASGETCHARACTERENCODING);
      try {
      ...
      /* String "                                                             */
      TestResult tr1 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_CLIENTDATAREQUEST_SIGRESOURCE_HASGETCHARACTERENCODINGRETURNS);
      try {
         String name = "getCharacterEncoding";
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_CLIENTDATAREQUEST_SIGRESOURCE_HASGETCONTENTLENGTH);
      try {
      ...
      TestResult tr3 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_CLIENTDATAREQUEST_SIGRESOURCE_HASGETCONTENTLENGTHRETURNS);
      try {
         String name = "getContentLength";
      ...
      TestResult tr4 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_CLIENTDATAREQUEST_SIGRESOURCE_HASGETCONTENTTYPE);
      try {
      ...
      TestResult tr5 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_CLIENTDATAREQUEST_SIGRESOURCE_HASGETCONTENTTYPERETURNS);
      try {
         String name = "getContentType";
         Class<?> retType = String.class;
         Class<?>[] parms = null;
      ...
      TestResult tr6 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_CLIENTDATAREQUEST_SIGRESOURCE_HASGETMETHOD);
      try {
      ...
      TestResult tr7 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_CLIENTDATAREQUEST_SIGRESOURCE_HASGETMETHODRETURNS);
      try {
         String name = "getMethod";
         Class<?> retType = String.class;
         Class<?>[] parms = null;
      ...
      TestResult tr8 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_CLIENTDATAREQUEST_SIGRESOURCE_HASGETPORTLETINPUTSTREAM);
      try {
      ...
      /* java.io.InputStream "                                                */
      TestResult tr9 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_CLIENTDATAREQUEST_SIGRESOURCE_HASGETPORTLETINPUTSTREAMRETURNS);
      try {
         String name = "getPortletInputStream";
      ...
      TestResult tr10 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_CLIENTDATAREQUEST_SIGRESOURCE_HASGETREADER);
      try {
      ...
      TestResult tr11 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_CLIENTDATAREQUEST_SIGRESOURCE_HASGETREADERRETURNS);
      try {
         String name = "getReader";
      ...
      TestResult tr12 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_CLIENTDATAREQUEST_SIGRESOURCE_HASSETCHARACTERENCODING);
      try {
      ...
      /* returns void "                                                       */
      TestResult tr13 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_CLIENTDATAREQUEST_SIGRESOURCE_HASSETCHARACTERENCODINGRETURNS);
      try {
         String name = "setCharacterEncoding";
      ...
      TestResult tr14 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_CLIENTDATAREQUEST_SIGRESOURCE_IMPLEMENTSPORTLETREQUEST);
      try {
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      writer.write("<div id=\"SigTestsResource_ClientDataRequest_SIGResource\">no resource output.</div>\n");
      ...
      writer.write("         document.getElementById(\"SigTestsResource_ClientDataRequest_SIGResource\").innerHTML=xhr.responseText;\n");
      writer.write("      }\n");
      writer.write("   };\n");
