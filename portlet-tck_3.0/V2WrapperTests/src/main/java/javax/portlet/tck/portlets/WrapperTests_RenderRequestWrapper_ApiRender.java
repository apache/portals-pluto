 ...
 * portlet WrapperTests_RenderRequestWrapper_ApiRender_event
 *
 */
public class WrapperTests_RenderRequestWrapper_ApiRender implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         WrapperTests_RenderRequestWrapper_ApiRender.class.getName();
