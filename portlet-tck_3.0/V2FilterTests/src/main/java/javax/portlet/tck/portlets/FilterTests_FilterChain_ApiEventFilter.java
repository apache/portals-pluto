 ...
 * portlet FilterTests_FilterChain_ApiEventFilter_event
 *
 */
public class FilterTests_FilterChain_ApiEventFilter implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         FilterTests_FilterChain_ApiEventFilter.class.getName();
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      /* next filter to be invoked"                                           */
      {
         ...
         TestButton tb = new TestButton("V2FilterTests_FilterChain_ApiEventFilter_invokeEventFilter", aurl);
         tb.writeTo(writer);
      }
      ...
      /* portlet Event method to be invoked"                                  */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2FilterTests_FilterChain_ApiEventFilter_invokeEventFilter2", aurl);
         tb.writeTo(writer);
      }
      ...
      /* chain, processing does not continue down the chain "                 */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2FilterTests_FilterChain_ApiEventFilter_invokeEventException", aurl);
         tb.writeTo(writer);
      }
