 ...
 * portlet SigTestsEnv_RenderMode_SIGRender_event
 *
 */
public class SigTestsEnv_RenderMode_SIGRender implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsEnv_RenderMode_SIGRender.class.getName();
