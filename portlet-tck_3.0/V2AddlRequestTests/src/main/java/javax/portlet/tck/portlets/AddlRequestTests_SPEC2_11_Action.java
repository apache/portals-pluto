...
public class AddlRequestTests_SPEC2_11_Action implements Portlet {
  private static final String LOG_CLASS = AddlRequestTests_SPEC2_11_Action.class.getName();
  ...
  public void processAction(ActionRequest portletReq, ActionResponse portletResp)
    ...
    portletReq.getPortletSession().setAttribute(
        Constants.RESULT_ATTR_PREFIX + "AddlRequestTests_SPEC2_11_Action", writer.toString(),
        APPLICATION_SCOPE);
  }
