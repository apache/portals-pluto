...
<%
      ...
      /* TestCase: V2DispatcherTests3S_SPEC2_19_ForwardJSPRender_dispatch4    */
      ...
      /* TestCase: V2DispatcherTests3S_SPEC2_19_ForwardJSPRender_invoke3      */
      /* Details: "Parameters to the forward method for a target servlet      */
      /* can be wrapped request and response classes from the portlet         */
      /* lifecyle method initiating the include"                              */
      TestResult tr1 = tcd.getTestResultFailed(V2DISPATCHERTESTS3S_SPEC2_19_FORWARDJSPRENDER_INVOKE3);
      /* TODO: implement test */
