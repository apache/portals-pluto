 ...
 * portlet SigTestsException_PortletException_SIGRender_event
 *
 */
public class SigTestsException_PortletException_SIGRender implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsException_PortletException_SIGRender.class.getName();
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      /* "                                                                    */
      TestResult tr0 = tcd.getTestResultFailed(V2SIGTESTSEXCEPTION_PORTLETEXCEPTION_SIGRENDER_CONSTRUCTOR);
      try {
         Class<?>[] parms = null;
      ...
      TestResult tr1 = tcd.getTestResultFailed(V2SIGTESTSEXCEPTION_PORTLETEXCEPTION_SIGRENDER_CONSTRUCTORA);
      try {
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2SIGTESTSEXCEPTION_PORTLETEXCEPTION_SIGRENDER_CONSTRUCTORB);
      try {
      ...
      TestResult tr3 = tcd.getTestResultFailed(V2SIGTESTSEXCEPTION_PORTLETEXCEPTION_SIGRENDER_CONSTRUCTORC);
      try {
      ...
      TestResult tr4 = tcd.getTestResultFailed(V2SIGTESTSEXCEPTION_PORTLETEXCEPTION_SIGRENDER_EXTENDSEXCEPTION);
      try {
