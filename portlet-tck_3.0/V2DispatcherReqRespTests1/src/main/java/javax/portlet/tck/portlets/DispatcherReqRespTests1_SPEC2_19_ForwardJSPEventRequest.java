...
public class DispatcherReqRespTests1_SPEC2_19_ForwardJSPEventRequest implements Portlet, ResourceServingPortlet {
   ...
   public void processAction(ActionRequest portletReq, ActionResponse portletResp)
      ...
      // Set parameter for: DispatcherReqRespTests1_SPEC2_19_ForwardJSPEventRequest
      portletResp.setRenderParameter(PARM_PREFIX + "V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPEventRequest_getParameter", "Value");

      // Set parameter for: DispatcherReqRespTests1_SPEC2_19_ForwardJSPEventRequest
      portletResp.setRenderParameter(PARM_PREFIX + "V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPEventRequest_getParameterMap", "Value");

      // Set parameter for: DispatcherReqRespTests1_SPEC2_19_ForwardJSPEventRequest
      portletResp.setRenderParameter(PARM_PREFIX + "V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPEventRequest_getParameterNames", "Value");

      // Set parameter for: DispatcherReqRespTests1_SPEC2_19_ForwardJSPEventRequest
      portletResp.setRenderParameter(PARM_PREFIX + "V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPEventRequest_getParameterValues", "Value");
