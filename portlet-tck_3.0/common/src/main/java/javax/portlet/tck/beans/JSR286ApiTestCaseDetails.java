...
public class JSR286ApiTestCaseDetails extends TestCaseDetails {
   ...
   static {
      ...
      tcd.put(V2ENVIRONMENTTESTS_PORTALCONTEXT_APIRENDER_GETPORTALINFO1, "Method getPortalInfo(): Returns a String containing the server name and version in the form name/version");
      tcd.put(V2ENVIRONMENTTESTS_PORTLETCONTEXT_APIRENDER_GETSERVERINFO1, "Method getServerInfo(): Returns a String containing the server name and version in the form name/version");
