 ...
 * portlet SigTestsFilter_ActionFilter_SIGRender_event
 *
 */
public class SigTestsFilter_ActionFilter_SIGRender implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsFilter_ActionFilter_SIGRender.class.getName();
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      try {
         ...
         Class<?>[] parms = {ActionRequest.class, ActionResponse.class, javax.portlet.filter.FilterChain.class};
      ...
      TestResult tr1 = tcd.getTestResultFailed(V2SIGTESTSFILTER_ACTIONFILTER_SIGRENDER_HASDOFILTERRETURNS);
      try {
         String name = "doFilter";
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2SIGTESTSFILTER_ACTIONFILTER_SIGRENDER_IMPLEMENTSPORTLETFILTER);
      try {
