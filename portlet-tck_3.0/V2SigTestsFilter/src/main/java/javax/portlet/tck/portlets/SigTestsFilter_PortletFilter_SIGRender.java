 ...
 * portlet SigTestsFilter_PortletFilter_SIGRender_event
 *
 */
public class SigTestsFilter_PortletFilter_SIGRender implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsFilter_PortletFilter_SIGRender.class.getName();
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      TestResult tr1 = tcd.getTestResultFailed(V2SIGTESTSFILTER_PORTLETFILTER_SIGRENDER_HASDESTROYRETURNS);
      try {
         String name = "destroy";
      ...
      TestResult tr3 = tcd.getTestResultFailed(V2SIGTESTSFILTER_PORTLETFILTER_SIGRENDER_HASINITRETURNS);
      try {
         String name = "init";
         Class<?> retType = void.class;
         Class<?>[] parms = {javax.portlet.filter.FilterConfig.class};
