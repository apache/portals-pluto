...
public class DispatcherTests_SPEC2_19_IncludeServletRender_servlet extends HttpServlet {
   ...
   protected void processTCKReq(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
         ...
         boolean ok = false;
         for (Cookie c : cs) {
            if (c.getName().equals(COOKIE_PREFIX + "DispatcherTests_SPEC2_19_IncludeServletRender")) {
               ok = true;
      ...
      try {
         String prop = portletReq.getProperty(PROP_PREFIX + "DispatcherTests_SPEC2_19_IncludeServletRender");
      ...
      try {
         ...
         tr10.setTcSuccess(ctxpath.equals("/DispatcherTests_SPEC2_19_IncludeServletRender_servlet"));
