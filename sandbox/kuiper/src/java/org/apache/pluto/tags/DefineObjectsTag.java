...
public class DefineObjectsTag extends TagSupport
{
    ...
    {
        PortletRequest renderRequest = (PortletRequest)pageContext.getRequest().getAttribute(PlutoConstants.PORTLET_REQUEST);
        RenderResponse renderResponse = (RenderResponse)pageContext.getRequest().getAttribute(PlutoConstants.PORTLET_RESPONSE);
        PortletConfig portletConfig = (PortletConfig)pageContext.getRequest().getAttribute(PlutoConstants.PORTLET_CONFIG);
