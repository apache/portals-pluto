...
public class DispatcherReqRespTests2_SPEC2_19_ForwardServletEventRequest_event implements Portlet, EventPortlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         DispatcherReqRespTests2_SPEC2_19_ForwardServletEventRequest_event.class.getName();
   ...
   public void processEvent(EventRequest portletReq, EventResponse portletResp)
      ...
      PortletRequestDispatcher rd = portletConfig.getPortletContext()
            .getRequestDispatcher("/DispatcherReqRespTests2_SPEC2_19_ForwardServletEventRequest_servlet?qparm1=qvalue1&qparm2=qvalue2");
