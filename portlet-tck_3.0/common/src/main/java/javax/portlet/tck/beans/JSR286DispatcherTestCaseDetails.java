...
public class JSR286DispatcherTestCaseDetails extends TestCaseDetails {
   ...
   static {
      ...
      tcd.put(SPEC2_19_DISPATCHINCLUDESERVLETACTION_ATTRIBUTES3, "If the request dispatcher is obtained through the getRequestDispatcher method, the request attribute javax.servlet.include.servlet_path will be set, and equals the value from HTTPServletRequest.getSerletPath for the first servlet in the include chain");
      ...
      tcd.put(SPEC2_19_DISPATCHFORWARDSERVLETACTION_ATTRIBUTES3, "If the request dispatcher is obtained through the getRequestDispatcher method, the request attribute javax.servlet.forward.servlet_path will be set, and equals the value from HTTPServletRequest.getSerletPath for the first servlet in the forward chain");
