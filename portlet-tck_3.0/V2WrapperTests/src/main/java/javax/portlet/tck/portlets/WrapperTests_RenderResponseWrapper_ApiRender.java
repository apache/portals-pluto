 ...
 * portlet WrapperTests_RenderResponseWrapper_ApiRender_event
 *
 */
public class WrapperTests_RenderResponseWrapper_ApiRender implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         WrapperTests_RenderResponseWrapper_ApiRender.class.getName();
