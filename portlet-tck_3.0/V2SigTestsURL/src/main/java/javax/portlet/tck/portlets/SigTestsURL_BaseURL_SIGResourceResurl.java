 ...
 * portlet SigTestsURL_BaseURL_SIGResourceResurl_event
 *
 */
public class SigTestsURL_BaseURL_SIGResourceResurl implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsURL_BaseURL_SIGResourceResurl.class.getName();
   ...
   public void serveResource(ResourceRequest portletReq, ResourceResponse portletResp)
      ...
      TestResult tr0 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERESURL_HASADDPROPERTY);
      try {
      ...
      /* void "                                                               */
      TestResult tr1 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERESURL_HASADDPROPERTYRETURNS);
      try {
         String name = "addProperty";
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERESURL_HASGETPARAMETERMAP);
      try {
      ...
      /* java.util.Map "                                                      */
      TestResult tr3 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERESURL_HASGETPARAMETERMAPRETURNS);
      try {
         String name = "getParameterMap";
      ...
      /* "                                                                    */
      TestResult tr4 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERESURL_HASSETPARAMETER);
      try {
      ...
      /* method "                                                             */
      TestResult tr5 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERESURL_HASSETPARAMETERA);
      try {
         String name = "setParameter";
         Class<?>[] exceptions = null;
         Class<?>[] parms = {String.class, String[].class};
      ...
      /* void "                                                               */
      TestResult tr6 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERESURL_HASSETPARAMETERRETURNS);
      try {
         String name = "setParameter";
         Class<?> retType = void.class;
         Class<?>[] parms = {String.class, String.class};
      ...
      /* returns void "                                                       */
      TestResult tr7 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERESURL_HASSETPARAMETERRETURNSA);
      try {
         String name = "setParameter";
         Class<?> retType = void.class;
         Class<?>[] parms = {String.class, String[].class};
      ...
      /* "                                                                    */
      TestResult tr8 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERESURL_HASSETPARAMETERS);
      try {
      ...
      /* void "                                                               */
      TestResult tr9 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERESURL_HASSETPARAMETERSRETURNS);
      try {
         String name = "setParameters";
         Class<?> retType = void.class;
         Class<?>[] parms = {java.util.Map.class};
      ...
      TestResult tr10 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERESURL_HASSETPROPERTY);
      try {
      ...
      /* void "                                                               */
      TestResult tr11 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERESURL_HASSETPROPERTYRETURNS);
      try {
         String name = "setProperty";
         Class<?> retType = void.class;
         Class<?>[] parms = {String.class, String.class};
      ...
      TestResult tr13 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERESURL_HASSETSECURERETURNS);
      try {
         String name = "setSecure";
         Class<?> retType = void.class;
         Class<?>[] parms = {boolean.class};
      ...
      TestResult tr15 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERESURL_HASTOSTRINGRETURNS);
      try {
         String name = "toString";
      ...
      TestResult tr18 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERESURL_HASWRITERETURNS);
      try {
         String name = "write";
         Class<?> retType = void.class;
         Class<?>[] parms = {java.io.Writer.class};
      ...
      /* returns void "                                                       */
      TestResult tr19 = tcd.getTestResultFailed(V2SIGTESTSURL_BASEURL_SIGRESOURCERESURL_HASWRITERETURNSA);
      try {
         String name = "write";
         Class<?> retType = void.class;
         Class<?>[] parms = {java.io.Writer.class, boolean.class};
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      writer.write("         document.getElementById(\"SigTestsURL_BaseURL_SIGResourceResurl\").innerHTML=xhr.responseText;\n");
      writer.write("      }\n");
      writer.write("   };\n");
