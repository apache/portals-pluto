 ...
 */
public class DispatcherTests_SPEC2_19_DispatchIncludeServletEvent implements Portlet {
   private static final String LOG_CLASS = 
         DispatcherTests_SPEC2_19_DispatchIncludeServletEvent.class.getName();
   ...
   public void render(RenderRequest renderRequest, RenderResponse renderResponse)
      ...
      /* TestCase: SPEC2_19_DispatchIncludeServletEvent_attributes1           */
      ...
      TestResult tr0 = tcd.getTestResultFailed(SPEC2_19_DISPATCHINCLUDESERVLETEVENT_ATTRIBUTES1);
      /* TODO: implement test */
      tr0.writeTo(writer);

      /* TestCase: SPEC2_19_DispatchIncludeServletEvent_attributes2           */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the request attribute                   */
      ...
      /* in the include chain"                                                */
      TestResult tr1 = tcd.getTestResultFailed(SPEC2_19_DISPATCHINCLUDESERVLETEVENT_ATTRIBUTES2);
      /* TODO: implement test */
      tr1.writeTo(writer);

      /* TestCase: SPEC2_19_DispatchIncludeServletEvent_attributes3           */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the request attribute                   */
      ...
      /* TestCase: SPEC2_19_DispatchIncludeServletEvent_attributes4           */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the request attribute                   */
      ...
      /* include chain"                                                       */
      TestResult tr3 = tcd.getTestResultFailed(SPEC2_19_DISPATCHINCLUDESERVLETEVENT_ATTRIBUTES4);
      /* TODO: implement test */
      tr3.writeTo(writer);

      /* TestCase: SPEC2_19_DispatchIncludeServletEvent_attributes5           */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the request attribute                   */
      ...
      /* in the include chain"                                                */
      TestResult tr4 = tcd.getTestResultFailed(SPEC2_19_DISPATCHINCLUDESERVLETEVENT_ATTRIBUTES5);
      /* TODO: implement test */
      tr4.writeTo(writer);

      /* TestCase: SPEC2_19_DispatchIncludeServletEvent_attributes6           */
      /* Details: "The request attribute javax.portlet.config must be set     */
      /* to the javax.portlet.PortletConfig object"                           */
      TestResult tr5 = tcd.getTestResultFailed(SPEC2_19_DISPATCHINCLUDESERVLETEVENT_ATTRIBUTES6);
      /* TODO: implement test */
      tr5.writeTo(writer);

      /* TestCase: SPEC2_19_DispatchIncludeServletEvent_attributes7           */
      ...
      TestResult tr6 = tcd.getTestResultFailed(SPEC2_19_DISPATCHINCLUDESERVLETEVENT_ATTRIBUTES7);
      /* TODO: implement test */
      tr6.writeTo(writer);

      /* TestCase: SPEC2_19_DispatchIncludeServletEvent_attributes8           */
      /* Details: "For includes from the processEvent method, The request     */
      /* attribute javax.portlet.response must be set to the                  */
      /* javax.portlet.EventResponse object"                                  */
      TestResult tr7 = tcd.getTestResultFailed(SPEC2_19_DISPATCHINCLUDESERVLETEVENT_ATTRIBUTES8);
      /* TODO: implement test */
      tr7.writeTo(writer);
