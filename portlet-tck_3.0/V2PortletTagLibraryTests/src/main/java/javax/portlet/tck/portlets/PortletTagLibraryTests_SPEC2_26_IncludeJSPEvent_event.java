...
public class PortletTagLibraryTests_SPEC2_26_IncludeJSPEvent_event implements Portlet, EventPortlet, ResourceServingPortlet {
   ...
   public void processEvent(EventRequest portletReq, EventResponse portletResp)
      ...
      String target = JSP_PREFIX + "PortletTagLibraryTests_SPEC2_26_IncludeJSPEvent" + JSP_SUFFIX + "?" + QUERY_STRING;
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      String msg = (String) portletReq.getPortletSession()
            .getAttribute(RESULT_ATTR_PREFIX + "PortletTagLibraryTests_SPEC2_26_IncludeJSPEvent", APPLICATION_SCOPE);
