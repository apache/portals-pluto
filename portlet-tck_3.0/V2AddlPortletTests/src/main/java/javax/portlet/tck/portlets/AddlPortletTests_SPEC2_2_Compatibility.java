...
public class AddlPortletTests_SPEC2_2_Compatibility implements Portlet {
   ...
   public void render(RenderRequest renderRequest, RenderResponse renderResponse)
      ...
      /* TestCase: SPEC2_2_Compatibility_deployJSR168_1                       */
      /* Details: "A portlet with the JSR 168 deployment descriptor can be    */
      /* deployed"                                                            */
      TestResult tr0 = tcd.getTestResultFailed(SPEC2_2_COMPATIBILITY_DEPLOYJSR168_1);
      /* TODO: implement test */

      /* TestCase: SPEC2_2_Compatibility_deployJSR168_2                       */
      /* Details: "A portlet implementing only the JSR 168 API can be         */
      /* deployed"                                                            */
      TestResult tr1 = tcd.getTestResultFailed(SPEC2_2_COMPATIBILITY_DEPLOYJSR168_2);
      /* TODO: implement test */
