 ...
 * portlet SigTestsRender_PortletResponse_SIGRender_event
 *
 */
public class SigTestsRender_PortletResponse_SIGRender implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsRender_PortletResponse_SIGRender.class.getName();
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      /* "                                                                    */
      TestResult tr0 = tcd.getTestResultFailed(V2SIGTESTSRENDER_PORTLETRESPONSE_SIGRENDER_HASADDPROPERTY);
      try {
      ...
      TestResult tr1 = tcd.getTestResultFailed(V2SIGTESTSRENDER_PORTLETRESPONSE_SIGRENDER_HASADDPROPERTYA);
      try {
         String name = "addProperty";
         Class<?>[] exceptions = null;
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2SIGTESTSRENDER_PORTLETRESPONSE_SIGRENDER_HASADDPROPERTYB);
      try {
         String name = "addProperty";
         Class<?>[] exceptions = null;
      ...
      /* returns void "                                                       */
      TestResult tr3 = tcd.getTestResultFailed(V2SIGTESTSRENDER_PORTLETRESPONSE_SIGRENDER_HASADDPROPERTYRETURNS);
      try {
         String name = "addProperty";
      ...
      TestResult tr4 = tcd.getTestResultFailed(V2SIGTESTSRENDER_PORTLETRESPONSE_SIGRENDER_HASADDPROPERTYRETURNSA);
      try {
         String name = "addProperty";
         Class<?> retType = void.class;
         Class<?>[] parms = {javax.servlet.http.Cookie.class};
      ...
      TestResult tr5 = tcd.getTestResultFailed(V2SIGTESTSRENDER_PORTLETRESPONSE_SIGRENDER_HASADDPROPERTYRETURNSB);
      try {
         String name = "addProperty";
         Class<?> retType = void.class;
         Class<?>[] parms = {String.class, org.w3c.dom.Element.class};
      ...
      TestResult tr6 = tcd.getTestResultFailed(V2SIGTESTSRENDER_PORTLETRESPONSE_SIGRENDER_HASCREATEELEMENT);
      try {
      ...
      /* org.w3c.dom.Element "                                                */
      TestResult tr7 = tcd.getTestResultFailed(V2SIGTESTSRENDER_PORTLETRESPONSE_SIGRENDER_HASCREATEELEMENTRETURNS);
      try {
         String name = "createElement";
      ...
      TestResult tr8 = tcd.getTestResultFailed(V2SIGTESTSRENDER_PORTLETRESPONSE_SIGRENDER_HASENCODEURL);
      try {
      ...
      TestResult tr9 = tcd.getTestResultFailed(V2SIGTESTSRENDER_PORTLETRESPONSE_SIGRENDER_HASENCODEURLRETURNS);
      try {
         String name = "encodeURL";
      ...
      TestResult tr10 = tcd.getTestResultFailed(V2SIGTESTSRENDER_PORTLETRESPONSE_SIGRENDER_HASGETNAMESPACE);
      try {
      ...
      TestResult tr11 = tcd.getTestResultFailed(V2SIGTESTSRENDER_PORTLETRESPONSE_SIGRENDER_HASGETNAMESPACERETURNS);
      try {
         String name = "getNamespace";
         Class<?> retType = String.class;
         Class<?>[] parms = null;
      ...
      /* "                                                                    */
      TestResult tr12 = tcd.getTestResultFailed(V2SIGTESTSRENDER_PORTLETRESPONSE_SIGRENDER_HASSETPROPERTY);
      try {
      ...
      /* returns void "                                                       */
      TestResult tr13 = tcd.getTestResultFailed(V2SIGTESTSRENDER_PORTLETRESPONSE_SIGRENDER_HASSETPROPERTYRETURNS);
      try {
         String name = "setProperty";
         Class<?> retType = void.class;
         Class<?>[] parms = {String.class, String.class};
