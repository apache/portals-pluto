 ...
 * portlet PortletTagLibraryTests3_SPEC2_26_IncludeJSPResource_event
 * @author ahmed
 */
public class PortletTagLibraryTests3_SPEC2_26_IncludeJSPResource extends GenericPortlet {
   ...
   public void processAction(ActionRequest portletReq, ActionResponse portletResp)
      ...
      if (action.equals("V2PortletTagLibraryTests3_SPEC2_26_IncludeJSPResource_actionURL1")) {
        ...
        /*
         * TestCase: V2PortletTagLibraryTests3_SPEC2_26_IncludeJSPResource_actionURL18 Details: "If the
   ...
   public void serveResource(ResourceRequest portletReq, ResourceResponse portletResp)
      ...
      if (portletReq.getParameter("action") != null) {
        ...
        if (action.equals("V2PortletTagLibraryTests3_SPEC2_26_IncludeJSPResource_resourceURL1")) {
          ...
          TestResult tr65 = tcd
              .getTestResultFailed(V2PORTLETTAGLIBRARYTESTS3_SPEC2_26_INCLUDEJSPRESOURCE_RESOURCEURL1);
          ...
          TestResult tr66 = tcd
              .getTestResultFailed(V2PORTLETTAGLIBRARYTESTS3_SPEC2_26_INCLUDEJSPRESOURCE_RESOURCEURL2);
          ...
          TestResult tr67 = tcd
              .getTestResultFailed(V2PORTLETTAGLIBRARYTESTS3_SPEC2_26_INCLUDEJSPRESOURCE_RESOURCEURL3);
          tr67.setTcSuccess(true);
          tr67.writeTo(writer);
        } else if (action
            .equals("V2PortletTagLibraryTests3_SPEC2_26_IncludeJSPResource_resourceURL4")
          ...
          TestResult tr68 = tcd
              .getTestResultFailed(V2PORTLETTAGLIBRARYTESTS3_SPEC2_26_INCLUDEJSPRESOURCE_RESOURCEURL4);
          ...
          TestResult tr69 = tcd
              .getTestResultFailed(V2PORTLETTAGLIBRARYTESTS3_SPEC2_26_INCLUDEJSPRESOURCE_RESOURCEURL5);
          tr69.setTcSuccess(true);
          tr69.writeTo(writer);
        } else if (action.equals("V2PortletTagLibraryTests3_SPEC2_26_IncludeJSPResource_resourceURL22")
          ...
          TestResult tr84 = tcd
              .getTestResultFailed(V2PORTLETTAGLIBRARYTESTS3_SPEC2_26_INCLUDEJSPRESOURCE_RESOURCEURL22);
          tr84.setTcSuccess(true);
          tr84.writeTo(writer);
        } else if (action.equals("V2PortletTagLibraryTests3_SPEC2_26_IncludeJSPResource_resourceURL23")
        ...
        } else if (action.equals("V2PortletTagLibraryTests3_SPEC2_26_IncludeJSPResource_paramResource2")
        ...
        } else if (action.equals("V2PortletTagLibraryTests3_SPEC2_26_IncludeJSPResource_paramResource3")
        ...
        } else if (action.equals("V2PortletTagLibraryTests3_SPEC2_26_IncludeJSPResource_paramResource5")
        ...
        } else if (action.equals("V2PortletTagLibraryTests3_SPEC2_26_IncludeJSPResource_paramResource6")
          ...
          String target = JSP_PREFIX + "PortletTagLibraryTests3_SPEC2_26_IncludeJSPResource" + JSP_SUFFIX + "?" + QUERY_STRING;
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      if (portletReq.getParameter("action") != null) {
        ...
        }  else if (action.equals("V2PortletTagLibraryTests3_SPEC2_26_IncludeJSPResource_renderURL2")) {
        ...
        } else if (action.equals("V2PortletTagLibraryTests3_SPEC2_26_IncludeJSPResource_renderURL11")) {
      ...
      writer.write("<div id=\"PortletTagLibraryTests3_SPEC2_26_IncludeJSPResource\">no resource output.</div>\n");
      ...
      writer.write("         document.getElementById(\"PortletTagLibraryTests3_SPEC2_26_IncludeJSPResource\").innerHTML=xhr.responseText;\n");
      
      /* 
       * Eval function Interpret JS code returned by the AJAX call.
       * Following are the script tags with ids, which need to be evaluated (interpreted) by browser.
       * These JS script tags are necessary for testing ResourceURL tags, since resourceURL
       * requires an AJAX function written in JS to get the HTML content.
       * For eg - The first script tag "getResourceCall" (See line 12 of PortletTagLibraryTests3_SPEC2_26_IncludeJSPResource.jsp)
       *          is a JS function used by all other script tags below to bring resource content
       *          via AJAX request. Since this script tag is already being returned by the current
       *          AJAX request, browser won't interpret it as JS unless being told.
       */
