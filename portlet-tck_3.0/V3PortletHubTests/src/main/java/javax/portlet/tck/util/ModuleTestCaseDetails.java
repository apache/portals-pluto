...
public class ModuleTestCaseDetails extends TestCaseDetails {
   ...
   static {
      ...
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_ADDEVENTLISTENER1, "The PortletInit object addEventListener function throws an IllegalArgumentException if no argument is provided");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_ADDEVENTLISTENER2, "The PortletInit object addEventListener function throws an IllegalArgumentException if 1 argument is provided");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_ADDEVENTLISTENER3, "The PortletInit object addEventListener function throws an IllegalArgumentException if too many (&gt;2) arguments are provided");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_ADDEVENTLISTENER4, "The PortletInit object addEventListener function throws an IllegalArgumentException if the type argument is not a string");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_ADDEVENTLISTENER5, "The PortletInit object addEventListener function throws an IllegalArgumentException if the function argument is not a function");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_ADDEVENTLISTENER6, "The PortletInit object addEventListener function throws an IllegalArgumentException if the type is null");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_ADDEVENTLISTENER7, "The PortletInit object addEventListener function throws an IllegalArgumentException if the function is null");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_ADDEVENTLISTENER8, "The PortletInit object addEventListener function throws an IllegalArgumentException if the type begins with \"portlet.\" but is neither \"portlet.onStateChange\" or \"portlet.onError\"");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_REMOVEEVENTLISTENER1, "The PortletInit object removeEventListener function throws an IllegalArgumentException if no argument is provided");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_REMOVEEVENTLISTENER2, "The PortletInit object removeEventListener function throws an IllegalArgumentException if too many (&gt;1) arguments are provided");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_REMOVEEVENTLISTENER3, "The PortletInit object removeEventListener function throws an IllegalArgumentException if the handle is null");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_REMOVEEVENTLISTENER4, "The PortletInit object removeEventListener function throws an IllegalArgumentException if the handle is undefined");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_REMOVEEVENTLISTENER5, "The PortletInit object removeEventListener function throws an IllegalArgumentException if the handle has an invalid value");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_CREATERESOURCEURL1, "The PortletInit object createResourceUrl function throws an IllegalArgumentException if too many (&gt;3) arguments are provided");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_CREATERESOURCEURL2, "The PortletInit object createResourceUrl function throws an IllegalArgumentException if resource parameters is invalid");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_CREATERESOURCEURL3, "The PortletInit object createResourceUrl function throws an IllegalArgumentException if the cacheability argument is invalid");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_SETRENDERSTATE1, "The PortletInit object setRenderState function throws an IllegalArgumentException if no argument is provided");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_SETRENDERSTATE2, "The PortletInit object setRenderState function throws an IllegalArgumentException if too many (&gt;1) arguments are provided");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_SETRENDERSTATE3, "The PortletInit object setRenderState function throws an IllegalArgumentException if the argument is not an object");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_SETRENDERSTATE4, "The PortletInit object setRenderState function throws an IllegalArgumentException if the single argument is null");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_SETRENDERSTATE5, "The PortletInit object setRenderState function throws an IllegalArgumentException if the argument does not have a \"parameters\" property");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_SETRENDERSTATE6, "The PortletInit object setRenderState function throws an IllegalArgumentException if the argument does not have a \"windowState\" property");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_SETRENDERSTATE7, "The PortletInit object setRenderState function throws an IllegalArgumentException if the argument does not have a \"portletMode\" property");
      ...
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_SETRENDERSTATEA, "The PortletInit object setRenderState function throws an IllegalArgumentException if \"windowState\" has an invalid value");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_SETRENDERSTATEB, "The PortletInit object setRenderState function throws an IllegalArgumentException if \"portletMode\" has an invalid value");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_ACTION1, "The PortletInit object action function throws an IllegalArgumentException if too many (&gt;2) arguments are provided");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_ACTION2, "The PortletInit object action function throws an IllegalArgumentException if a single argument is null");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_ACTION3, "The PortletInit object action function throws an IllegalArgumentException if the element argument is null");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_ACTION4, "The PortletInit object action function throws an IllegalArgumentException if action parameters is null");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_ACTION5, "The PortletInit object action function throws an IllegalArgumentException if action parameters is invalid");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_ACTION6, "The PortletInit object action function throws an IllegalArgumentException if the element argument is invalid");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_ACTION7, "The PortletInit object action function throws an IllegalArgumentException if there are 2 element arguments");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_ACTION8, "The PortletInit object action function throws an IllegalArgumentException if there are 2 action parameters arguments");
      ...
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_STARTPARTIALACTION1, "The PortletInit object startPartialAction function throws an IllegalArgumentException if too many (&gt;1) arguments are provided");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_STARTPARTIALACTION2, "The PortletInit object startPartialAction function throws an IllegalArgumentException if the single argument is null");
      tcd.put(V3PORTLETHUBTESTS_SPEC_23_JSEXC_STARTPARTIALACTION3, "The PortletInit object startPartialAction function throws an IllegalArgumentException if action parameters is invalid");
