 ...
 * portlet DispatcherTests4_SPEC2_19_IncludeServletAction_event
 *
 */
public class DispatcherTests4_SPEC2_19_IncludeServletAction implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         DispatcherTests4_SPEC2_19_IncludeServletAction.class.getName();
   ...
   public void processAction(ActionRequest portletReq, ActionResponse portletResp)
      ...
      String target = SERVLET_PREFIX + "DispatcherTests4_SPEC2_19_IncludeServletAction_servlet" + SERVLET_SUFFIX + "?" + QUERY_STRING;
      PortletRequestDispatcher rd = portletConfig.getPortletContext()
            .getRequestDispatcher(target);
      rd.include(portletReq, portletResp);
   }
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      String msg = (String) ps.getAttribute(RESULT_ATTR_PREFIX + "DispatcherTests4_SPEC2_19_IncludeServletAction", APPLICATION_SCOPE);
      if (msg != null) {
