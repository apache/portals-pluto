 ...
 * portlet AddlPortletTests_SPEC2_6_RenderConfig3_event
 *
 */
public class AddlPortletTests_SPEC2_6_RenderConfig3 implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         AddlPortletTests_SPEC2_6_RenderConfig3.class.getName();
