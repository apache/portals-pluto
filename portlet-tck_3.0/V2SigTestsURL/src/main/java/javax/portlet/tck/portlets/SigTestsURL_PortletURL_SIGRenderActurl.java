 ...
 * portlet SigTestsURL_PortletURL_SIGRenderActurl_event
 *
 */
public class SigTestsURL_PortletURL_SIGRenderActurl implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsURL_PortletURL_SIGRenderActurl.class.getName();
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      TestResult tr0 = tcd.getTestResultFailed(V2SIGTESTSURL_PORTLETURL_SIGRENDERACTURL_HASGETPORTLETMODE);
      try {
      ...
      /* "                                                                    */
      TestResult tr1 = tcd.getTestResultFailed(V2SIGTESTSURL_PORTLETURL_SIGRENDERACTURL_HASGETPORTLETMODERETURNS);
      try {
         String name = "getPortletMode";
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2SIGTESTSURL_PORTLETURL_SIGRENDERACTURL_HASGETWINDOWSTATE);
      try {
      ...
      /* "                                                                    */
      TestResult tr3 = tcd.getTestResultFailed(V2SIGTESTSURL_PORTLETURL_SIGRENDERACTURL_HASGETWINDOWSTATERETURNS);
      try {
         String name = "getWindowState";
      ...
      /* method "                                                             */
      TestResult tr4 = tcd.getTestResultFailed(V2SIGTESTSURL_PORTLETURL_SIGRENDERACTURL_HASREMOVEPUBLICRENDERPARAMETER);
      try {
      ...
      /* returns void "                                                       */
      TestResult tr5 = tcd.getTestResultFailed(V2SIGTESTSURL_PORTLETURL_SIGRENDERACTURL_HASREMOVEPUBLICRENDERPARAMETERRETURNS);
      try {
         String name = "removePublicRenderParameter";
      ...
      TestResult tr6 = tcd.getTestResultFailed(V2SIGTESTSURL_PORTLETURL_SIGRENDERACTURL_HASSETPORTLETMODE);
      try {
      ...
      /* void "                                                               */
      TestResult tr7 = tcd.getTestResultFailed(V2SIGTESTSURL_PORTLETURL_SIGRENDERACTURL_HASSETPORTLETMODERETURNS);
      try {
         String name = "setPortletMode";
         Class<?> retType = void.class;
         Class<?>[] parms = {PortletMode.class};
      ...
      TestResult tr8 = tcd.getTestResultFailed(V2SIGTESTSURL_PORTLETURL_SIGRENDERACTURL_HASSETWINDOWSTATE);
      try {
      ...
      /* void "                                                               */
      TestResult tr9 = tcd.getTestResultFailed(V2SIGTESTSURL_PORTLETURL_SIGRENDERACTURL_HASSETWINDOWSTATERETURNS);
      try {
         String name = "setWindowState";
         Class<?> retType = void.class;
         Class<?>[] parms = {WindowState.class};
      ...
      TestResult tr10 = tcd.getTestResultFailed(V2SIGTESTSURL_PORTLETURL_SIGRENDERACTURL_IMPLEMENTSBASEURL);
      try {
