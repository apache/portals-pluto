 ...
 * portlet DispatcherTests_SPEC2_19_ForwardServletAction_event
 *
 */
public class DispatcherTests_SPEC2_19_ForwardServletAction implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         DispatcherTests_SPEC2_19_ForwardServletAction.class.getName();
   ...
   public void processAction(ActionRequest portletReq, ActionResponse portletResp)
      ...
      Cookie c = new Cookie(COOKIE_PREFIX +"DispatcherTests_SPEC2_19_ForwardServletAction", COOKIE_VALUE);
      c.setMaxAge(10);
      portletResp.addProperty(c);
      portletResp.addProperty(PROP_PREFIX +"DispatcherTests_SPEC2_19_ForwardServletAction", PROP_VALUE);
      ...
      PortletRequestDispatcher rd = portletConfig.getPortletContext()
            .getRequestDispatcher("/DispatcherTests_SPEC2_19_ForwardServletAction_servlet?qparm1=qvalue1&qparm2=qvalue2");
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      String msg = (String) ps.getAttribute(RESULT_ATTR_PREFIX + "DispatcherTests_SPEC2_19_ForwardServletAction", APPLICATION_SCOPE);
      if (msg != null) {
         ...
         {
            PortletURL aurl = portletResp.createActionURL();
            TestButton tb = new TestButton("SPEC2_19_ForwardServletAction_attributes1", aurl);
            tb.writeTo(writer);
         }
         ...
         {
            PortletURL aurl = portletResp.createActionURL();
            TestButton tb = new TestButton("SPEC2_19_ForwardServletAction_attributes2", aurl);
            tb.writeTo(writer);
         }
         ...
         {
            PortletURL aurl = portletResp.createActionURL();
            TestButton tb = new TestButton("SPEC2_19_ForwardServletAction_attributes3", aurl);
            tb.writeTo(writer);
         }
         ...
         {
            PortletURL aurl = portletResp.createActionURL();
            TestButton tb = new TestButton("SPEC2_19_ForwardServletAction_attributes4", aurl);
            tb.writeTo(writer);
         }
         ...
         {
            PortletURL aurl = portletResp.createActionURL();
            TestButton tb = new TestButton("SPEC2_19_ForwardServletAction_attributes5", aurl);
            tb.writeTo(writer);
         }
         ...
         {
            PortletURL aurl = portletResp.createActionURL();
            TestButton tb = new TestButton("SPEC2_19_ForwardServletAction_attributes6", aurl);
            tb.writeTo(writer);
         }
         ...
         {
            PortletURL aurl = portletResp.createActionURL();
            TestButton tb = new TestButton("SPEC2_19_ForwardServletAction_attributes7", aurl);
            tb.writeTo(writer);
         }
         ...
         {
            PortletURL aurl = portletResp.createActionURL();
            TestButton tb = new TestButton("SPEC2_19_ForwardServletAction_attributes8", aurl);
            tb.writeTo(writer);
         }
