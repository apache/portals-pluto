 ...
 * portlet SigTestsEnv_PortletConfig_SIGRender_event
 *
 */
public class SigTestsEnv_PortletConfig_SIGRender implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsEnv_PortletConfig_SIGRender.class.getName();
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      /* "                                                                    */
      TestResult tr0 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETCONTAINERRUNTIMEOPTIONS);
      try {
      ...
      TestResult tr1 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETCONTAINERRUNTIMEOPTIONSRETURNS);
      try {
         String name = "getContainerRuntimeOptions";
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETDEFAULTNAMESPACE);
      try {
      ...
      /* String "                                                             */
      TestResult tr3 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETDEFAULTNAMESPACERETURNS);
      try {
         String name = "getDefaultNamespace";
      ...
      TestResult tr4 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETINITPARAMETER);
      try {
      ...
      TestResult tr5 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETINITPARAMETERNAMES);
      try {
      ...
      TestResult tr6 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETINITPARAMETERNAMESRETURNS);
      try {
         String name = "getInitParameterNames";
      ...
      /* String "                                                             */
      TestResult tr7 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETINITPARAMETERRETURNS);
      try {
         String name = "getInitParameter";
         Class<?> retType = String.class;
         Class<?>[] parms = {String.class};
      ...
      TestResult tr8 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETPORTLETCONTEXT);
      try {
      ...
      /* PortletContext "                                                     */
      TestResult tr9 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETPORTLETCONTEXTRETURNS);
      try {
         String name = "getPortletContext";
      ...
      TestResult tr10 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETPORTLETNAME);
      try {
      ...
      TestResult tr11 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETPORTLETNAMERETURNS);
      try {
         String name = "getPortletName";
         Class<?> retType = String.class;
         Class<?>[] parms = null;
      ...
      TestResult tr12 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETPROCESSINGEVENTQNAMES);
      try {
      ...
      /* java.util.Enumeration "                                              */
      TestResult tr13 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETPROCESSINGEVENTQNAMESRETURNS);
      try {
         String name = "getProcessingEventQNames";
         Class<?> retType = java.util.Enumeration.class;
         Class<?>[] parms = null;
      ...
      /* method "                                                             */
      TestResult tr14 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETPUBLICRENDERPARAMETERNAMES);
      try {
      ...
      TestResult tr15 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETPUBLICRENDERPARAMETERNAMESRETURNS);
      try {
         String name = "getPublicRenderParameterNames";
         Class<?> retType = java.util.Enumeration.class;
         Class<?>[] parms = null;
      ...
      TestResult tr16 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETPUBLISHINGEVENTQNAMES);
      try {
      ...
      /* java.util.Enumeration "                                              */
      TestResult tr17 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETPUBLISHINGEVENTQNAMESRETURNS);
      try {
         String name = "getPublishingEventQNames";
         Class<?> retType = java.util.Enumeration.class;
         Class<?>[] parms = null;
      ...
      /* method "                                                             */
      TestResult tr18 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETRESOURCEBUNDLE);
      try {
      ...
      TestResult tr19 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETRESOURCEBUNDLERETURNS);
      try {
         String name = "getResourceBundle";
      ...
      TestResult tr20 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETSUPPORTEDLOCALES);
      try {
      ...
      /* java.util.Enumeration "                                              */
      TestResult tr21 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETCONFIG_SIGRENDER_HASGETSUPPORTEDLOCALESRETURNS);
      try {
         String name = "getSupportedLocales";
         Class<?> retType = java.util.Enumeration.class;
         Class<?>[] parms = null;
