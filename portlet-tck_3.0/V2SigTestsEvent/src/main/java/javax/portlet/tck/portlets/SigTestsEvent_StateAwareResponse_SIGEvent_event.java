 ...
 */
public class SigTestsEvent_StateAwareResponse_SIGEvent_event implements Portlet, EventPortlet, ResourceServingPortlet {
   ...
   public void processEvent(EventRequest portletReq, EventResponse portletResp)
      ...
      TestResult tr0 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASGETPORTLETMODE);
      try {
      ...
      /* PortletMode "                                                        */
      TestResult tr1 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASGETPORTLETMODERETURNS);
      try {
         String name = "getPortletMode";
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASGETRENDERPARAMETERMAP);
      try {
      ...
      /* java.util.Map "                                                      */
      TestResult tr3 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASGETRENDERPARAMETERMAPRETURNS);
      try {
         String name = "getRenderParameterMap";
      ...
      TestResult tr4 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASGETWINDOWSTATE);
      try {
      ...
      /* WindowState "                                                        */
      TestResult tr5 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASGETWINDOWSTATERETURNS);
      try {
         String name = "getWindowState";
      ...
      /* method "                                                             */
      TestResult tr6 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASREMOVEPUBLICRENDERPARAMETER);
      try {
      ...
      /* returns void "                                                       */
      TestResult tr7 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASREMOVEPUBLICRENDERPARAMETERRETURNS);
      try {
         String name = "removePublicRenderParameter";
      ...
      TestResult tr8 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASSETEVENT);
      try {
      ...
      /* java.io.Serializable)  method "                                      */
      TestResult tr9 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASSETEVENTA);
      try {
         String name = "setEvent";
         Class<?>[] exceptions = null;
      ...
      TestResult tr10 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASSETEVENTRETURNS);
      try {
         String name = "setEvent";
         Class<?> retType = void.class;
         Class<?>[] parms = {javax.xml.namespace.QName.class, java.io.Serializable.class};
      ...
      /* java.io.Serializable) returns void "                                 */
      TestResult tr11 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASSETEVENTRETURNSA);
      try {
         String name = "setEvent";
         Class<?> retType = void.class;
         Class<?>[] parms = {String.class, java.io.Serializable.class};
      ...
      TestResult tr12 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASSETPORTLETMODE);
      try {
      ...
      /* void "                                                               */
      TestResult tr13 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASSETPORTLETMODERETURNS);
      try {
         String name = "setPortletMode";
         Class<?> retType = void.class;
         Class<?>[] parms = {PortletMode.class};
      ...
      /* method "                                                             */
      TestResult tr14 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASSETRENDERPARAMETER);
      try {
      ...
      /* Details: "EventResponse has a setRenderParameter(String, String[])   */
      /* method "                                                             */
      TestResult tr15 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASSETRENDERPARAMETERA);
      try {
         String name = "setRenderParameter";
         Class<?>[] exceptions = null;
         Class<?>[] parms = {String.class, String[].class};
      ...
      /* returns void "                                                       */
      TestResult tr16 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASSETRENDERPARAMETERRETURNS);
      try {
         String name = "setRenderParameter";
         Class<?> retType = void.class;
         Class<?>[] parms = {String.class, String.class};
      ...
      /* String[]) returns void "                                             */
      TestResult tr17 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASSETRENDERPARAMETERRETURNSA);
      try {
         String name = "setRenderParameter";
         Class<?> retType = void.class;
         Class<?>[] parms = {String.class, String[].class};
      ...
      /* method "                                                             */
      TestResult tr18 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASSETRENDERPARAMETERS);
      try {
      ...
      /* returns void "                                                       */
      TestResult tr19 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASSETRENDERPARAMETERSRETURNS);
      try {
         String name = "setRenderParameters";
         Class<?> retType = void.class;
         Class<?>[] parms = {java.util.Map.class};
      ...
      TestResult tr20 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASSETWINDOWSTATE);
      try {
      ...
      /* void "                                                               */
      TestResult tr21 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_HASSETWINDOWSTATERETURNS);
      try {
         String name = "setWindowState";
         Class<?> retType = void.class;
         Class<?>[] parms = {WindowState.class};
      ...
      TestResult tr22 = tcd.getTestResultFailed(V2SIGTESTSEVENT_STATEAWARERESPONSE_SIGEVENT_IMPLEMENTSPORTLETRESPONSE);
      try {
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      String msg = (String) portletReq.getPortletSession()
            .getAttribute(RESULT_ATTR_PREFIX + "SigTestsEvent_StateAwareResponse_SIGEvent", APPLICATION_SCOPE);
