 ...
 * Used by portlet: DispatcherTests_SPEC2_19_ForwardServletResource
 *
 * @author nick
 *
 */
public class DispatcherTests_SPEC2_19_ForwardServletResource_servlet extends HttpServlet {
   private static final String LOG_CLASS = 
         DispatcherTests_SPEC2_19_ForwardServletResource_servlet.class.getName();
   ...
   protected void processTCKReq(HttpServletRequest request, HttpServletResponse response)
      ...
      /* TestCase: SPEC2_19_ForwardServletResource_dispatch1                  */
      ...
      TestResult tr0 = tcd.getTestResultFailed(SPEC2_19_FORWARDSERVLETRESOURCE_DISPATCH1);
      try {
      ...
      /* TestCase: SPEC2_19_ForwardServletResource_dispatch2                  */
      /* Details: "Parameters specified in the query strings must be          */
      /* aggregated with the portlet render parameters"                       */
      TestResult tr1 = tcd.getTestResultFailed(SPEC2_19_FORWARDSERVLETRESOURCE_DISPATCH2);
      try {
      ...
      /* TestCase: SPEC2_19_ForwardServletResource_dispatch3                  */
      ...
      TestResult tr2 = tcd.getTestResultFailed(SPEC2_19_FORWARDSERVLETRESOURCE_DISPATCH3);
      try {
         String qparm1 = portletReq.getParameter("qparm1");
         String qparm2 = portletReq.getParameter("qparm2");
         boolean ok = ((qparm1 != null) && (qparm2 != null));
      ...
      /* TestCase: SPEC2_19_ForwardServletResource_dispatch4                  */
      ...
      /* servlet "                                                            */
      TestResult tr4 = tcd.getTestResultFailed(SPEC2_19_FORWARDSERVLETRESOURCE_INVOKE1);
      try {
      ...
      /* TestCase: SPEC2_19_ForwardServletResource_invoke2                    */
      ...
      TestResult tr5 = tcd.getTestResultFailed(SPEC2_19_FORWARDSERVLETRESOURCE_INVOKE2);
      try {
         // If this gets executed, include worked.
      ...
      /* TestCase: SPEC2_19_ForwardServletResource_invoke3                    */
      /* Details: "Parameters to the include method for a target servlet      */
      ...
      /* invocation"                                                          */
      TestResult tr7 = tcd.getTestResultFailed(SPEC2_19_FORWARDSERVLETRESOURCE_INVOKE4);
      try {
         tr7.setTcSuccess(reqTid == svtTid);
      } catch(Exception e) {tr7.appendTcDetail(e.toString());}
      tr7.writeTo(writer);

      /* TestCase: SPEC2_19_ForwardServletResource_invoke7                    */
      /* Details: "The path elements of the request object exposed to the     */
      /* target servlet must reflect the path used to obtain the              */
      /* RequestDispatcher"                                                   */
      TestResult tr8 = tcd.getTestResultFailed(SPEC2_19_FORWARDSERVLETRESOURCE_INVOKE7);
      try {
      ...
      /* TestCase: SPEC2_19_ForwardServletResource_commit1                    */
      ...
      TestResult tr9 = tcd.getTestResultFailed(SPEC2_19_FORWARDSERVLETRESOURCE_COMMIT1);
      /* TODO: implement test */
      ...
      TestResult tr10 = tcd.getTestResultFailed(SPEC2_19_FORWARDSERVLETRESOURCE_ATTRIBUTES1);
      try {
      ...
      /* in the forward chain"                                                */
      TestResult tr11 = tcd.getTestResultFailed(SPEC2_19_FORWARDSERVLETRESOURCE_ATTRIBUTES2);
      try {
      ...
      /* in the forward chain"                                                */
      TestResult tr12 = tcd.getTestResultFailed(SPEC2_19_FORWARDSERVLETRESOURCE_ATTRIBUTES3);
      try {
      ...
      /* forward chain"                                                       */
      TestResult tr13 = tcd.getTestResultFailed(SPEC2_19_FORWARDSERVLETRESOURCE_ATTRIBUTES4);
      try {
      ...
      /* in the forward chain"                                                */
      TestResult tr14 = tcd.getTestResultFailed(SPEC2_19_FORWARDSERVLETRESOURCE_ATTRIBUTES5);
      try {
      ...
      TestResult tr15 = tcd.getTestResultFailed(SPEC2_19_FORWARDSERVLETRESOURCE_ATTRIBUTES6);
      try {
      ...
      TestResult tr16 = tcd.getTestResultFailed(SPEC2_19_FORWARDSERVLETRESOURCE_ATTRIBUTES7);
      try {
      ...
      TestResult tr17 = tcd.getTestResultFailed(SPEC2_19_FORWARDSERVLETRESOURCE_ATTRIBUTES8);
      try {
