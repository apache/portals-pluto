...
public class DispatcherReqRespTests3_SPEC2_19_IncludeJSPActionRequest implements Portlet, ResourceServingPortlet {
   ...
   public void processAction(ActionRequest portletReq, ActionResponse portletResp)
      ...
      // Set parameter for: DispatcherReqRespTests3_SPEC2_19_IncludeJSPActionRequest
      portletResp.setRenderParameter(PARM_PREFIX + "V2DispatcherReqRespTests3_SPEC2_19_IncludeJSPActionRequest_getParameter", "Value");

      // Set parameter for: DispatcherReqRespTests3_SPEC2_19_IncludeJSPActionRequest
      portletResp.setRenderParameter(PARM_PREFIX + "V2DispatcherReqRespTests3_SPEC2_19_IncludeJSPActionRequest_getParameterMap", "Value");

      // Set parameter for: DispatcherReqRespTests3_SPEC2_19_IncludeJSPActionRequest
      portletResp.setRenderParameter(PARM_PREFIX + "V2DispatcherReqRespTests3_SPEC2_19_IncludeJSPActionRequest_getParameterNames", "Value");

      // Set parameter for: DispatcherReqRespTests3_SPEC2_19_IncludeJSPActionRequest
      portletResp.setRenderParameter(PARM_PREFIX + "V2DispatcherReqRespTests3_SPEC2_19_IncludeJSPActionRequest_getParameterValues", "Value");
