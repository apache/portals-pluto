...
public class ResponseTests_StateAwareResponse_ApiAction implements Portlet, ResourceServingPortlet {
   ...
   public void processAction(ActionRequest portletReq, ActionResponse portletResp)
      ...
      TestResult tr14 = tcd.getTestResultFailed(V2RESPONSETESTS_STATEAWARERESPONSE_APIACTION_SETRENDERPARAMETERS10);
      try {
         try {
            Map<String, String[]> parms = new HashMap<String, String[]>();
            parms.put("parm1", new String[]{"val1-1", "val1-2"});
      ...
      /* null "                                                               */
      TestResult tr15 = tcd.getTestResultFailed(V2RESPONSETESTS_STATEAWARERESPONSE_APIACTION_SETRENDERPARAMETERS11);
      try {
         try {
            Map<String, String[]> parms = new HashMap<String, String[]>();
      ...
      TestResult tr23 = tcd.getTestResultFailed(V2RESPONSETESTS_STATEAWARERESPONSE_APIACTION_SETRENDERPARAMETERA7);
      try {
         try {
      ...
      /* Details: "Method setRenderParameter(String, String[]): Throws        */
      /* IllegalArgumentException if the name is null"                        */
      TestResult tr28 = tcd.getTestResultFailed(V2RESPONSETESTS_STATEAWARERESPONSE_APIACTION_SETRENDERPARAMETERB4);
      try {
         try {
      ...
      TestResult tr29 = tcd.getTestResultFailed(V2RESPONSETESTS_STATEAWARERESPONSE_APIACTION_SETRENDERPARAMETERB5);
      try {
         try {
            portletResp.setRenderParameter(null, new String[]{"val1-1", "val1-2"});
      ...
      /* is null"                                                             */
      TestResult tr32 = tcd.getTestResultFailed(V2RESPONSETESTS_STATEAWARERESPONSE_APIACTION_SETEVENTA2);
      try {
         try {
      ...
      /* IllegalArgumentException if the name is null"                        */
      TestResult tr37 = tcd.getTestResultFailed(V2RESPONSETESTS_STATEAWARERESPONSE_APIACTION_SETEVENTB2);
      try {
         try {
            portletResp.setEvent((javax.xml.namespace.QName)null, "value");
      ...
      /* IllegalArgumentException if the name is null"                        */
      TestResult tr50 = tcd.getTestResultFailed(V2RESPONSETESTS_STATEAWARERESPONSE_APIACTION_REMOVEPUBLICRENDERPARAMETER2);
      try {
         try {
