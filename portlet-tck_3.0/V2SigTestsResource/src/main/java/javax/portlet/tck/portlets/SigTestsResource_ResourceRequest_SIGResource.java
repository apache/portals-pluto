 ...
 * portlet SigTestsResource_ResourceRequest_SIGResource_event
 *
 */
public class SigTestsResource_ResourceRequest_SIGResource implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsResource_ResourceRequest_SIGResource.class.getName();
   ...
   public void serveResource(ResourceRequest portletReq, ResourceResponse portletResp)
      ...
      TestResult tr0 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCEREQUEST_SIGRESOURCE_FIELDETAG);
      try {
      ...
      TestResult tr1 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCEREQUEST_SIGRESOURCE_HASGETCACHEABILITY);
      try {
      ...
      /* "                                                                    */
      TestResult tr2 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCEREQUEST_SIGRESOURCE_HASGETCACHEABILITYRETURNS);
      try {
         String name = "getCacheability";
      ...
      TestResult tr3 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCEREQUEST_SIGRESOURCE_HASGETETAG);
      try {
         String name = "getETag";
         Class<?>[] exceptions = null;
         Class<?>[] parms = null;
      ...
      TestResult tr4 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCEREQUEST_SIGRESOURCE_HASGETETAGRETURNS);
      try {
         String name = "getETag";
         Class<?> retType = String.class;
         Class<?>[] parms = null;
      ...
      /* method "                                                             */
      TestResult tr5 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCEREQUEST_SIGRESOURCE_HASGETPRIVATERENDERPARAMETERMAP);
      try {
      ...
      /* TestCase: V2SigTestsResource_ResourceRequest_SIGResource_hasGetPrivateRenderParameterMapReturns */
      /* Details: "ResourceRequest method getPrivateRenderParameterMap()      */
      /* returns java.util.Map "                                              */
      TestResult tr6 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCEREQUEST_SIGRESOURCE_HASGETPRIVATERENDERPARAMETERMAPRETURNS);
      try {
         String name = "getPrivateRenderParameterMap";
      ...
      TestResult tr7 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCEREQUEST_SIGRESOURCE_HASGETRESOURCEID);
      try {
      ...
      TestResult tr8 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCEREQUEST_SIGRESOURCE_HASGETRESOURCEIDRETURNS);
      try {
         String name = "getResourceID";
         Class<?> retType = String.class;
         Class<?>[] parms = null;
      ...
      TestResult tr9 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCEREQUEST_SIGRESOURCE_HASGETRESPONSECONTENTTYPE);
      try {
      ...
      /* String "                                                             */
      TestResult tr10 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCEREQUEST_SIGRESOURCE_HASGETRESPONSECONTENTTYPERETURNS);
      try {
         String name = "getResponseContentType";
         Class<?> retType = String.class;
         Class<?>[] parms = null;
      ...
      /* "                                                                    */
      TestResult tr11 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCEREQUEST_SIGRESOURCE_HASGETRESPONSECONTENTTYPES);
      try {
      ...
      TestResult tr12 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCEREQUEST_SIGRESOURCE_HASGETRESPONSECONTENTTYPESRETURNS);
      try {
         String name = "getResponseContentTypes";
      ...
      TestResult tr13 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCEREQUEST_SIGRESOURCE_IMPLEMENTSCLIENTDATAREQUEST);
      try {
