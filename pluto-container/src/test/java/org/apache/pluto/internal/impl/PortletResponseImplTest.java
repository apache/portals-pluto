...
public class PortletResponseImplTest extends MockObjectTestCase
{
    ...
    protected void setUp( ) throws Exception
    {
        ...
        // MimeResponseImpl needs a ExpirationCacheDD to implement cache control.
        Mock mockPortletDefinition = mock( PortletDD.class );
        mockPortletDefinition.expects( once() ).method( "getExpirationCacheDD" ).will( returnValue( null ) );
        
        Mock mockPortletEntity = mock( PortletEntity.class );
        mockPortletEntity.expects( once() ).method( "getPortletDefinition" ).will( returnValue( mockPortletDefinition.proxy() ) );
        
        Mock mockWindow = mock( InternalPortletWindow.class );
        mockWindow.expects( once() ).method( "getPortletEntity" ).will( returnValue( mockPortletEntity.proxy() ) );
                
        InternalPortletWindow window = (InternalPortletWindow) mockWindow.proxy();        
