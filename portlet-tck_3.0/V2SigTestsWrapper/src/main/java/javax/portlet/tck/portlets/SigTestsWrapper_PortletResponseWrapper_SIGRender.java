 ...
 * portlet SigTestsWrapper_PortletResponseWrapper_SIGRender_event
 *
 */
public class SigTestsWrapper_PortletResponseWrapper_SIGRender implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsWrapper_PortletResponseWrapper_SIGRender.class.getName();
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      TestResult tr0 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_PORTLETRESPONSEWRAPPER_SIGRENDER_CONSTRUCTOR);
      try {
      ...
      /* method "                                                             */
      TestResult tr1 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_PORTLETRESPONSEWRAPPER_SIGRENDER_HASADDPROPERTY);
      try {
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_PORTLETRESPONSEWRAPPER_SIGRENDER_HASADDPROPERTYA);
      try {
         String name = "addProperty";
         Class<?>[] exceptions = null;
      ...
      TestResult tr3 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_PORTLETRESPONSEWRAPPER_SIGRENDER_HASADDPROPERTYB);
      try {
         String name = "addProperty";
         Class<?>[] exceptions = null;
      ...
      /* String) returns void "                                               */
      TestResult tr4 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_PORTLETRESPONSEWRAPPER_SIGRENDER_HASADDPROPERTYRETURNS);
      try {
         String name = "addProperty";
      ...
      TestResult tr5 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_PORTLETRESPONSEWRAPPER_SIGRENDER_HASADDPROPERTYRETURNSA);
      try {
         String name = "addProperty";
         Class<?> retType = void.class;
         Class<?>[] parms = {String.class, org.w3c.dom.Element.class};
      ...
      TestResult tr6 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_PORTLETRESPONSEWRAPPER_SIGRENDER_HASADDPROPERTYRETURNSB);
      try {
         String name = "addProperty";
         Class<?> retType = void.class;
         Class<?>[] parms = {javax.servlet.http.Cookie.class};
      ...
      /* method "                                                             */
      TestResult tr7 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_PORTLETRESPONSEWRAPPER_SIGRENDER_HASCREATEELEMENT);
      try {
      ...
      TestResult tr8 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_PORTLETRESPONSEWRAPPER_SIGRENDER_HASCREATEELEMENTRETURNS);
      try {
         String name = "createElement";
      ...
      TestResult tr9 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_PORTLETRESPONSEWRAPPER_SIGRENDER_HASENCODEURL);
      try {
      ...
      /* String "                                                             */
      TestResult tr10 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_PORTLETRESPONSEWRAPPER_SIGRENDER_HASENCODEURLRETURNS);
      try {
         String name = "encodeURL";
      ...
      TestResult tr11 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_PORTLETRESPONSEWRAPPER_SIGRENDER_HASGETNAMESPACE);
      try {
      ...
      /* String "                                                             */
      TestResult tr12 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_PORTLETRESPONSEWRAPPER_SIGRENDER_HASGETNAMESPACERETURNS);
      try {
         String name = "getNamespace";
         Class<?> retType = String.class;
         Class<?>[] parms = null;
      ...
      TestResult tr13 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_PORTLETRESPONSEWRAPPER_SIGRENDER_HASGETRESPONSE);
      try {
      ...
      /* PortletResponse "                                                    */
      TestResult tr14 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_PORTLETRESPONSEWRAPPER_SIGRENDER_HASGETRESPONSERETURNS);
      try {
         String name = "getResponse";
      ...
      /* method "                                                             */
      TestResult tr15 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_PORTLETRESPONSEWRAPPER_SIGRENDER_HASSETPROPERTY);
      try {
      ...
      /* String) returns void "                                               */
      TestResult tr16 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_PORTLETRESPONSEWRAPPER_SIGRENDER_HASSETPROPERTYRETURNS);
      try {
         String name = "setProperty";
         Class<?> retType = void.class;
         Class<?>[] parms = {String.class, String.class};
      ...
      TestResult tr17 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_PORTLETRESPONSEWRAPPER_SIGRENDER_HASSETRESPONSE);
      try {
      ...
      TestResult tr18 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_PORTLETRESPONSEWRAPPER_SIGRENDER_HASSETRESPONSERETURNS);
      try {
         String name = "setResponse";
         Class<?> retType = void.class;
         Class<?>[] parms = {PortletResponse.class};
      ...
      TestResult tr19 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_PORTLETRESPONSEWRAPPER_SIGRENDER_IMPLEMENTSPORTLETRESPONSE);
      try {
