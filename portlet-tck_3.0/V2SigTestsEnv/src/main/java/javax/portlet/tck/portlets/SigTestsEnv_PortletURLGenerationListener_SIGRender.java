 ...
 * portlet SigTestsEnv_PortletURLGenerationListener_SIGRender_event
 *
 */
public class SigTestsEnv_PortletURLGenerationListener_SIGRender implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsEnv_PortletURLGenerationListener_SIGRender.class.getName();
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      TestResult tr0 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETURLGENERATIONLISTENER_SIGRENDER_HASFILTERACTIONURL);
      try {
      ...
      TestResult tr1 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETURLGENERATIONLISTENER_SIGRENDER_HASFILTERACTIONURLRETURNS);
      try {
         String name = "filterActionURL";
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETURLGENERATIONLISTENER_SIGRENDER_HASFILTERRENDERURL);
      try {
      ...
      TestResult tr3 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETURLGENERATIONLISTENER_SIGRENDER_HASFILTERRENDERURLRETURNS);
      try {
         String name = "filterRenderURL";
         Class<?> retType = void.class;
         Class<?>[] parms = {PortletURL.class};
      ...
      TestResult tr4 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETURLGENERATIONLISTENER_SIGRENDER_HASFILTERRESOURCEURL);
      try {
      ...
      TestResult tr5 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETURLGENERATIONLISTENER_SIGRENDER_HASFILTERRESOURCEURLRETURNS);
      try {
         String name = "filterResourceURL";
         Class<?> retType = void.class;
         Class<?>[] parms = {ResourceURL.class};
