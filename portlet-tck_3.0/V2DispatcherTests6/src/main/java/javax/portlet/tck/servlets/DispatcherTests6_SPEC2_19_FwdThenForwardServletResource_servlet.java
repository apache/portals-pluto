 ...
 * Used by portlet: DispatcherTests6_SPEC2_19_FwdThenForwardServletResource
 *
 * @author nick
 *
 */
public class DispatcherTests6_SPEC2_19_FwdThenForwardServletResource_servlet extends HttpServlet {
   private static final String LOG_CLASS = 
         DispatcherTests6_SPEC2_19_FwdThenForwardServletResource_servlet.class.getName();
   ...
   protected void processTCKReq(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
         String sname = SERVLET_PREFIX + "DispatcherTests6_SPEC2_19_FwdThenForwardServletResource_servlet" + SERVLET_SUFFIX;
