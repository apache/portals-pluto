 ...
 * portlet SigTestsResource_PortletResponse_SIGResource_event
 *
 */
public class SigTestsResource_PortletResponse_SIGResource implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsResource_PortletResponse_SIGResource.class.getName();
   ...
   public void serveResource(ResourceRequest portletReq, ResourceResponse portletResp)
      ...
      /* method "                                                             */
      TestResult tr0 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_PORTLETRESPONSE_SIGRESOURCE_HASADDPROPERTY);
      try {
      ...
      TestResult tr1 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_PORTLETRESPONSE_SIGRESOURCE_HASADDPROPERTYA);
      try {
         String name = "addProperty";
         Class<?>[] exceptions = null;
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_PORTLETRESPONSE_SIGRESOURCE_HASADDPROPERTYB);
      try {
         String name = "addProperty";
         Class<?>[] exceptions = null;
      ...
      /* returns void "                                                       */
      TestResult tr3 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_PORTLETRESPONSE_SIGRESOURCE_HASADDPROPERTYRETURNS);
      try {
         String name = "addProperty";
      ...
      TestResult tr4 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_PORTLETRESPONSE_SIGRESOURCE_HASADDPROPERTYRETURNSA);
      try {
         String name = "addProperty";
         Class<?> retType = void.class;
         Class<?>[] parms = {javax.servlet.http.Cookie.class};
      ...
      TestResult tr5 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_PORTLETRESPONSE_SIGRESOURCE_HASADDPROPERTYRETURNSB);
      try {
         String name = "addProperty";
         Class<?> retType = void.class;
         Class<?>[] parms = {String.class, org.w3c.dom.Element.class};
      ...
      TestResult tr6 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_PORTLETRESPONSE_SIGRESOURCE_HASCREATEELEMENT);
      try {
      ...
      /* org.w3c.dom.Element "                                                */
      TestResult tr7 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_PORTLETRESPONSE_SIGRESOURCE_HASCREATEELEMENTRETURNS);
      try {
         String name = "createElement";
      ...
      TestResult tr8 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_PORTLETRESPONSE_SIGRESOURCE_HASENCODEURL);
      try {
      ...
      /* "                                                                    */
      TestResult tr9 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_PORTLETRESPONSE_SIGRESOURCE_HASENCODEURLRETURNS);
      try {
         String name = "encodeURL";
      ...
      TestResult tr10 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_PORTLETRESPONSE_SIGRESOURCE_HASGETNAMESPACE);
      try {
      ...
      TestResult tr11 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_PORTLETRESPONSE_SIGRESOURCE_HASGETNAMESPACERETURNS);
      try {
         String name = "getNamespace";
         Class<?> retType = String.class;
         Class<?>[] parms = null;
      ...
      /* method "                                                             */
      TestResult tr12 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_PORTLETRESPONSE_SIGRESOURCE_HASSETPROPERTY);
      try {
      ...
      /* returns void "                                                       */
      TestResult tr13 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_PORTLETRESPONSE_SIGRESOURCE_HASSETPROPERTYRETURNS);
      try {
         String name = "setProperty";
         Class<?> retType = void.class;
         Class<?>[] parms = {String.class, String.class};
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      writer.write("<div id=\"SigTestsResource_PortletResponse_SIGResource\">no resource output.</div>\n");
      ...
      writer.write("         document.getElementById(\"SigTestsResource_PortletResponse_SIGResource\").innerHTML=xhr.responseText;\n");
      writer.write("      }\n");
      writer.write("   };\n");
