...
/**
 * The <code>Filter</code> an object that performs filtering 
 * tasks on either the request to a portlet, or on the response from 
 * a portlet, or both.
 * <p>
...
public interface Filter {
     ...
     * portlet container each time a request/response pair is passed 
     ...
     * the Filter to pass on the request and response to the next 
     ...
     *      of one of the request wrappers (
     *      <code>ActionRequestWrapper</code>, 
     *      <code>EventRequestWrapper</code>, 
     *      <code>RenderRequestWrapper</code>, 
     *      <code>ResourceRequestWrapper)</code> 
     ...
     *      of one of the response wrappers (
     *      <code>ActionResponseWrapper</code>, 
     *      <code>EventResponseWrapper</code>, 
     *      <code>RenderResponseWrapper</code>) 
