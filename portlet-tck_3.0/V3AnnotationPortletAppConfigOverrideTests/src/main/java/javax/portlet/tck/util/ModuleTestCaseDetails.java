...
public class ModuleTestCaseDetails extends TestCaseDetails {
   ...
   public final static String V3ANNOTATIONPORTLETAPPCONFIGOVERRIDETESTS_SPEC1_28_USERATTRIBUTES_DECLARINGUSERATTRIBUTES2 = "V3AnnotationPortletAppConfigOverrideTests_SPEC1_28_UserAttributes_declaringUserAttributes2";
   public final static String V3ANNOTATIONPORTLETAPPCONFIGOVERRIDETESTS_SPEC1_28_USERATTRIBUTES_DECLARINGUSERATTRIBUTES3 = "V3AnnotationPortletAppConfigOverrideTests_SPEC1_28_UserAttributes_declaringUserAttributes3";
   public final static String V3ANNOTATIONPORTLETAPPCONFIGOVERRIDETESTS_SPEC1_28_RESOURCEBUNDLE_DECLARINGRESOURCEBUNDLE2 = "V3AnnotationPortletAppConfigOverrideTests_SPEC1_28_ResourceBundle_declaringResourceBundle2";
   public final static String V3ANNOTATIONPORTLETAPPCONFIGOVERRIDETESTS_SPEC1_28_RESOURCEBUNDLE_DECLARINGRESOURCEBUNDLE3 = "V3AnnotationPortletAppConfigOverrideTests_SPEC1_28_ResourceBundle_declaringResourceBundle3";
   ...
   static {
      ...
      tcd.put(V3ANNOTATIONPORTLETAPPCONFIGOVERRIDETESTS_SPEC1_28_USERATTRIBUTES_DECLARINGUSERATTRIBUTES2, "A user attribute declared in the @PortletApplication annotation could be overridden by deployment descriptor portlet.xml");
      tcd.put(V3ANNOTATIONPORTLETAPPCONFIGOVERRIDETESTS_SPEC1_28_USERATTRIBUTES_DECLARINGUSERATTRIBUTES3, "The portlet container merges the user attributes declared in the @PortletApplication annotation and deployment descriptor portlet.xml");
      tcd.put(V3ANNOTATIONPORTLETAPPCONFIGOVERRIDETESTS_SPEC1_28_RESOURCEBUNDLE_DECLARINGRESOURCEBUNDLE2, "The resource bundle defined in the @PortletApplication annotation could be overridden by deployment descriptor portlet.xml");
      tcd.put(V3ANNOTATIONPORTLETAPPCONFIGOVERRIDETESTS_SPEC1_28_RESOURCEBUNDLE_DECLARINGRESOURCEBUNDLE3, "The portlet container merges the resource bundles declared in the @PortletApplication annotation and deployment descriptor portlet.xml");
      ...
      tcd.put(V3ANNOTATIONPORTLETAPPCONFIGOVERRIDETESTS_SPEC1_28_EVENTCONFIGURATION1_DECLARINGEVENTS3, "An event with cannot be declared two times - once in @PortletApplication then again in deployment descriptor portlet.xml");
      ...
      tcd.put(V3ANNOTATIONPORTLETAPPCONFIGOVERRIDETESTS_SPEC1_28_PUBLICRENDERPARAMETERS1_DECLARINGPRP2, "A public render parameters cannot be declared two times - once in @PortletApplication then again in deployment descriptor portlet.xml");
