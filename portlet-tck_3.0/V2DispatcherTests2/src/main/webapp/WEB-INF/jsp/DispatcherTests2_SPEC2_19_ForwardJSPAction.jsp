...
<%
      ...
      try {
         ...
         boolean ok = false;
         for (Cookie c : cs) {
            if (c.getName().equals(COOKIE_PREFIX + "DispatcherTests2_SPEC2_19_ForwardJSPAction")) {
               ok = true;
      ...
      try {
         String prop = portletReq.getProperty(PROP_PREFIX + "DispatcherTests2_SPEC2_19_ForwardJSPAction");
      ...
      try {
         ...
         tr10.setTcSuccess(ctxpath.equals("/DispatcherTests2_SPEC2_19_ForwardJSPAction"));
