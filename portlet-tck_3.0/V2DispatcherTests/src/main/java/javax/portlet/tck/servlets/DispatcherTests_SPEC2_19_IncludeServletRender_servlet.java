...
public class DispatcherTests_SPEC2_19_IncludeServletRender_servlet extends HttpServlet {
   ...
   protected void processTCKReq(HttpServletRequest request, HttpServletResponse response)
      ...
      TestResult tr0 = tcd.getTestResultFailed(SPEC2_19_INCLUDESERVLETRENDER_ATTRIBUTES1);
      /* TODO: implement test */
      tr0.writeTo(writer);
      ...
      /* in the include chain"                                                */
      TestResult tr1 = tcd.getTestResultFailed(SPEC2_19_INCLUDESERVLETRENDER_ATTRIBUTES2);
      /* TODO: implement test */
      tr1.writeTo(writer);
      ...
      /* in the include chain"                                                */
      TestResult tr2 = tcd.getTestResultFailed(SPEC2_19_INCLUDESERVLETRENDER_ATTRIBUTES3);
      /* TODO: implement test */
      tr2.writeTo(writer);
      ...
      /* include chain"                                                       */
      TestResult tr3 = tcd.getTestResultFailed(SPEC2_19_INCLUDESERVLETRENDER_ATTRIBUTES4);
      /* TODO: implement test */
      tr3.writeTo(writer);
      ...
      /* in the include chain"                                                */
      TestResult tr4 = tcd.getTestResultFailed(SPEC2_19_INCLUDESERVLETRENDER_ATTRIBUTES5);
      /* TODO: implement test */
      tr4.writeTo(writer);
      ...
      TestResult tr5 = tcd.getTestResultFailed(SPEC2_19_INCLUDESERVLETRENDER_ATTRIBUTES6);
      /* TODO: implement test */
      tr5.writeTo(writer);
      ...
      TestResult tr6 = tcd.getTestResultFailed(SPEC2_19_INCLUDESERVLETRENDER_ATTRIBUTES7);
      /* TODO: implement test */
      tr6.writeTo(writer);
      ...
      TestResult tr7 = tcd.getTestResultFailed(SPEC2_19_INCLUDESERVLETRENDER_ATTRIBUTES8);
      /* TODO: implement test */
      tr7.writeTo(writer);
