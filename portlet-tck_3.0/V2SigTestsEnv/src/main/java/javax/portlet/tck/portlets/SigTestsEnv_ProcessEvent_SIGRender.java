 ...
 * portlet SigTestsEnv_ProcessEvent_SIGRender_event
 *
 */
public class SigTestsEnv_ProcessEvent_SIGRender implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsEnv_ProcessEvent_SIGRender.class.getName();
