...
<%
      ...
      TestResult tr1 = tcd.getTestResultFailed(V2DISPATCHERTESTS3S_SPEC2_19_INCLUDEJSPACTION_INVOKE3);
      /* TODO: implement test */
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2DISPATCHERTESTS3S_SPEC2_19_INCLUDEJSPACTION_INVOKE8);
      /* TODO: implement test */
      tr2.appendTcDetail("Not implemented.");
      tr2.writeTo(writer);

      request.getSession().setAttribute(
                   Constants.RESULT_ATTR_PREFIX + "DispatcherTests3S_SPEC2_19_IncludeJSPAction",
                   writer.toString());
%>
