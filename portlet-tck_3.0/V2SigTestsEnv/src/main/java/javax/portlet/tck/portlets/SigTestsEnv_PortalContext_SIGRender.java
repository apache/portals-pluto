 ...
 * portlet SigTestsEnv_PortalContext_SIGRender_event
 *
 */
public class SigTestsEnv_PortalContext_SIGRender implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsEnv_PortalContext_SIGRender.class.getName();
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      TestResult tr0 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTALCONTEXT_SIGRENDER_FIELDMARKUP_HEAD_ELEMENT_SUPPORT);
      try {
      ...
      TestResult tr1 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTALCONTEXT_SIGRENDER_HASGETPORTALINFO);
      try {
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTALCONTEXT_SIGRENDER_HASGETPORTALINFORETURNS);
      try {
         String name = "getPortalInfo";
      ...
      TestResult tr4 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTALCONTEXT_SIGRENDER_HASGETPROPERTYNAMES);
      try {
      ...
      TestResult tr5 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTALCONTEXT_SIGRENDER_HASGETPROPERTYNAMESRETURNS);
      try {
         String name = "getPropertyNames";
      ...
      /* "                                                                    */
      TestResult tr6 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTALCONTEXT_SIGRENDER_HASGETPROPERTYRETURNS);
      try {
         String name = "getProperty";
         Class<?> retType = String.class;
         Class<?>[] parms = {String.class};
      ...
      TestResult tr7 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTALCONTEXT_SIGRENDER_HASGETSUPPORTEDPORTLETMODES);
      try {
      ...
      /* java.util.Enumeration "                                              */
      TestResult tr8 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTALCONTEXT_SIGRENDER_HASGETSUPPORTEDPORTLETMODESRETURNS);
      try {
         String name = "getSupportedPortletModes";
         Class<?> retType = java.util.Enumeration.class;
         Class<?>[] parms = null;
      ...
      TestResult tr9 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTALCONTEXT_SIGRENDER_HASGETSUPPORTEDWINDOWSTATES);
      try {
      ...
      /* java.util.Enumeration "                                              */
      TestResult tr10 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTALCONTEXT_SIGRENDER_HASGETSUPPORTEDWINDOWSTATESRETURNS);
      try {
         String name = "getSupportedWindowStates";
         Class<?> retType = java.util.Enumeration.class;
         Class<?>[] parms = null;
