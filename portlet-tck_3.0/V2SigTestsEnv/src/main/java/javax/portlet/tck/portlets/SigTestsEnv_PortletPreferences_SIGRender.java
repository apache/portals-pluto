 ...
 * portlet SigTestsEnv_PortletPreferences_SIGRender_event
 *
 */
public class SigTestsEnv_PortletPreferences_SIGRender implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsEnv_PortletPreferences_SIGRender.class.getName();
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      /* "                                                                    */
      TestResult tr1 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETPREFERENCES_SIGRENDER_HASGETMAPRETURNS);
      try {
         String name = "getMap";
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETPREFERENCES_SIGRENDER_HASGETNAMES);
      try {
      ...
      TestResult tr3 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETPREFERENCES_SIGRENDER_HASGETNAMESRETURNS);
      try {
         String name = "getNames";
      ...
      /* method "                                                             */
      TestResult tr4 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETPREFERENCES_SIGRENDER_HASGETVALUE);
      try {
      ...
      /* returns String "                                                     */
      TestResult tr5 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETPREFERENCES_SIGRENDER_HASGETVALUERETURNS);
      try {
         String name = "getValue";
      ...
      /* method "                                                             */
      TestResult tr6 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETPREFERENCES_SIGRENDER_HASGETVALUES);
      try {
      ...
      /* returns String[] "                                                   */
      TestResult tr7 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETPREFERENCES_SIGRENDER_HASGETVALUESRETURNS);
      try {
         String name = "getValues";
         Class<?> retType = String[].class;
         Class<?>[] parms = {String.class, String[].class};
      ...
      TestResult tr8 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETPREFERENCES_SIGRENDER_HASISREADONLY);
      try {
      ...
      /* boolean "                                                            */
      TestResult tr9 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETPREFERENCES_SIGRENDER_HASISREADONLYRETURNS);
      try {
         String name = "isReadOnly";
      ...
      TestResult tr11 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETPREFERENCES_SIGRENDER_HASRESETRETURNS);
      try {
         String name = "reset";
      ...
      /* ReadOnlyException method "                                           */
      TestResult tr12 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETPREFERENCES_SIGRENDER_HASSETVALUE);
      try {
      ...
      /* returns void "                                                       */
      TestResult tr13 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETPREFERENCES_SIGRENDER_HASSETVALUERETURNS);
      try {
         String name = "setValue";
         Class<?> retType = void.class;
         Class<?>[] parms = {String.class, String.class};
      ...
      TestResult tr14 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETPREFERENCES_SIGRENDER_HASSETVALUES);
      try {
      ...
      /* returns void "                                                       */
      TestResult tr15 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETPREFERENCES_SIGRENDER_HASSETVALUESRETURNS);
      try {
         String name = "setValues";
         Class<?> retType = void.class;
         Class<?>[] parms = {String.class, String[].class};
      ...
      TestResult tr17 = tcd.getTestResultFailed(V2SIGTESTSENV_PORTLETPREFERENCES_SIGRENDER_HASSTORERETURNS);
      try {
         String name = "store";
         Class<?> retType = void.class;
         Class<?>[] parms = null;
