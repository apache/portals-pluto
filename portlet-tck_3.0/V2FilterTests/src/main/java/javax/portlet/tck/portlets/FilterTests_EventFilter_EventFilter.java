 ...
 * portlet FilterTests_EventFilter_EventFilter_event
 *
 */
public class FilterTests_EventFilter_EventFilter implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         FilterTests_EventFilter_EventFilter.class.getName();
   ...
   public void processAction(ActionRequest portletReq, ActionResponse portletResp)
      ...
      QName eventQName = new QName(TCKNAMESPACE,
             "FilterTests_EventFilter_EventFilter");
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      /* descriptor"                                                          */
      {
         ...
         TestButton tb = new TestButton("V2FilterTests_EventFilter_EventFilter_canBeConfigured1", aurl);
         tb.writeTo(writer);
      }
      ...
      /* portlet descriptor"                                                  */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2FilterTests_EventFilter_EventFilter_canBeConfigured2", aurl);
         tb.writeTo(writer);
      }
      ...
      /* method is called before the processEvent method for the portlet"     */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2FilterTests_EventFilter_EventFilter_doFilterIsCalled", aurl);
         tb.writeTo(writer);
      }
      ...
      /* next filter, the processEventMethod is called"                       */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2FilterTests_EventFilter_EventFilter_doFilterProcessEvent1", aurl);
         tb.writeTo(writer);
      }
      ...
      /* filters are defined"                                                 */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2FilterTests_EventFilter_EventFilter_doFilterProcessEvent2", aurl);
         tb.writeTo(writer);
      }
      ...
      /* is not called"                                                       */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2FilterTests_EventFilter_EventFilter_doFilterBlock", aurl);
         tb.writeTo(writer);
      }
      ...
      /* is not called"                                                       */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2FilterTests_EventFilter_EventFilter_doFilterException1", aurl);
         tb.writeTo(writer);
      }
      ...
      /* filter is called"                                                    */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2FilterTests_EventFilter_EventFilter_doFilterException2", aurl);
         tb.writeTo(writer);
      }
      ...
      /* the EventResponse may be examined"                                   */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2FilterTests_EventFilter_EventFilter_doFilterExamine", aurl);
         tb.writeTo(writer);
      }
