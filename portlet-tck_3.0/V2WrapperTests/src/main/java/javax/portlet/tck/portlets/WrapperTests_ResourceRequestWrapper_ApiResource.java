 ...
 * portlet WrapperTests_ResourceRequestWrapper_ApiResource_event
 *
 */
public class WrapperTests_ResourceRequestWrapper_ApiResource implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         WrapperTests_ResourceRequestWrapper_ApiResource.class.getName();
   ...
   public void serveResource(ResourceRequest portletReq, ResourceResponse portletResp)
      ...
      ResourceRequestWrapperChecker wc = new ResourceRequestWrapperChecker(portletReq);
      ...
      /* TestCase: V2WrapperTests_ResourceRequestWrapper_ApiResource_getPortletInputStream */
      /* Details: "Method getPortletInputStream(): Calls wrapped method"      */
      TestResult tr0 = tcd.getTestResultFailed(V2WRAPPERTESTS_RESOURCEREQUESTWRAPPER_APIRESOURCE_GETPORTLETINPUTSTREAM);
      try {
         Object[] args = {};
      ...
      TestResult tr1 = tcd.getTestResultFailed(V2WRAPPERTESTS_RESOURCEREQUESTWRAPPER_APIRESOURCE_GETREADER);
      try {
         Object[] args = {};
      ...
      /* TestCase: V2WrapperTests_ResourceRequestWrapper_ApiResource_setCharacterEncoding */
      /* Details: "Method setCharacterEncoding(String): Calls wrapped         */
      /* method"                                                              */
      TestResult tr2 = tcd.getTestResultFailed(V2WRAPPERTESTS_RESOURCEREQUESTWRAPPER_APIRESOURCE_SETCHARACTERENCODING);
      try {
         String parm1 = "val1";
         Object[] args = {parm1};
      ...
      /* object"                                                              */
      TestResult tr3 = tcd.getTestResultFailed(V2WRAPPERTESTS_RESOURCEREQUESTWRAPPER_APIRESOURCE_GETREQUEST);
      try {
      ...
      TestResult tr4 = tcd.getTestResultFailed(V2WRAPPERTESTS_RESOURCEREQUESTWRAPPER_APIRESOURCE_SETREQUEST);
      try {
      ...
      /* TestCase: V2WrapperTests_ResourceRequestWrapper_ApiResource_getCharacterEncoding */
      /* Details: "Method getCharacterEncoding(): Calls wrapped method"       */
      TestResult tr5 = tcd.getTestResultFailed(V2WRAPPERTESTS_RESOURCEREQUESTWRAPPER_APIRESOURCE_GETCHARACTERENCODING);
      try {
         Object[] args = {};
      ...
      /* TestCase: V2WrapperTests_ResourceRequestWrapper_ApiResource_getContentLength */
      /* Details: "Method getContentLength(): Calls wrapped method"           */
      TestResult tr6 = tcd.getTestResultFailed(V2WRAPPERTESTS_RESOURCEREQUESTWRAPPER_APIRESOURCE_GETCONTENTLENGTH);
      try {
         Object[] args = {};
      ...
      /* TestCase: V2WrapperTests_ResourceRequestWrapper_ApiResource_getContentType */
      /* Details: "Method getContentType(): Calls wrapped method"             */
      TestResult tr7 = tcd.getTestResultFailed(V2WRAPPERTESTS_RESOURCEREQUESTWRAPPER_APIRESOURCE_GETCONTENTTYPE);
      try {
         Object[] args = {};
      ...
      TestResult tr8 = tcd.getTestResultFailed(V2WRAPPERTESTS_RESOURCEREQUESTWRAPPER_APIRESOURCE_GETETAG);
      try {
         Object[] args = {};
      ...
      TestResult tr9 = tcd.getTestResultFailed(V2WRAPPERTESTS_RESOURCEREQUESTWRAPPER_APIRESOURCE_GETMETHOD);
      try {
         Object[] args = {};
      ...
      /* TestCase: V2WrapperTests_ResourceRequestWrapper_ApiResource_getResourceID */
      /* Details: "Method getResourceID(): Calls wrapped method"              */
      TestResult tr10 = tcd.getTestResultFailed(V2WRAPPERTESTS_RESOURCEREQUESTWRAPPER_APIRESOURCE_GETRESOURCEID);
      try {
         Object[] args = {};
      ...
      /* TestCase: V2WrapperTests_ResourceRequestWrapper_ApiResource_getPrivateRenderParameterMap */
      /* Details: "Method getPrivateRenderParameterMap(): Calls wrapped       */
      /* method"                                                              */
      TestResult tr11 = tcd.getTestResultFailed(V2WRAPPERTESTS_RESOURCEREQUESTWRAPPER_APIRESOURCE_GETPRIVATERENDERPARAMETERMAP);
      try {
         Object[] args = {};
      ...
      /* TestCase: V2WrapperTests_ResourceRequestWrapper_ApiResource_getCacheability */
      /* Details: "Method getCacheability(): Calls wrapped method"            */
      TestResult tr12 = tcd.getTestResultFailed(V2WRAPPERTESTS_RESOURCEREQUESTWRAPPER_APIRESOURCE_GETCACHEABILITY);
      try {
         Object[] args = {};
