...
public class JSR286SignatureTestCaseDetails extends TestCaseDetails {
   ...
   public final static String V2SIGTESTSURL_BASEURL_SIGRENDER_HASADDPROPERTY = "V2SigTestsURL_BaseURL_SIGRender_hasAddProperty";
   public final static String V2SIGTESTSURL_BASEURL_SIGRENDER_HASADDPROPERTYRETURNS = "V2SigTestsURL_BaseURL_SIGRender_hasAddPropertyReturns";
   public final static String V2SIGTESTSURL_BASEURL_SIGRENDER_HASGETPARAMETERMAP = "V2SigTestsURL_BaseURL_SIGRender_hasGetParameterMap";
   public final static String V2SIGTESTSURL_BASEURL_SIGRENDER_HASGETPARAMETERMAPRETURNS = "V2SigTestsURL_BaseURL_SIGRender_hasGetParameterMapReturns";
   public final static String V2SIGTESTSURL_BASEURL_SIGRENDER_HASSETPARAMETER = "V2SigTestsURL_BaseURL_SIGRender_hasSetParameter";
   public final static String V2SIGTESTSURL_BASEURL_SIGRENDER_HASSETPARAMETERA = "V2SigTestsURL_BaseURL_SIGRender_hasSetParameterA";
   public final static String V2SIGTESTSURL_BASEURL_SIGRENDER_HASSETPARAMETERRETURNS = "V2SigTestsURL_BaseURL_SIGRender_hasSetParameterReturns";
   public final static String V2SIGTESTSURL_BASEURL_SIGRENDER_HASSETPARAMETERRETURNSA = "V2SigTestsURL_BaseURL_SIGRender_hasSetParameterReturnsA";
   public final static String V2SIGTESTSURL_BASEURL_SIGRENDER_HASSETPARAMETERS = "V2SigTestsURL_BaseURL_SIGRender_hasSetParameters";
   public final static String V2SIGTESTSURL_BASEURL_SIGRENDER_HASSETPARAMETERSRETURNS = "V2SigTestsURL_BaseURL_SIGRender_hasSetParametersReturns";
   public final static String V2SIGTESTSURL_BASEURL_SIGRENDER_HASSETPROPERTY = "V2SigTestsURL_BaseURL_SIGRender_hasSetProperty";
   public final static String V2SIGTESTSURL_BASEURL_SIGRENDER_HASSETPROPERTYRETURNS = "V2SigTestsURL_BaseURL_SIGRender_hasSetPropertyReturns";
   public final static String V2SIGTESTSURL_BASEURL_SIGRENDER_HASSETSECURE = "V2SigTestsURL_BaseURL_SIGRender_hasSetSecure";
   public final static String V2SIGTESTSURL_BASEURL_SIGRENDER_HASSETSECURERETURNS = "V2SigTestsURL_BaseURL_SIGRender_hasSetSecureReturns";
   public final static String V2SIGTESTSURL_BASEURL_SIGRENDER_HASTOSTRING = "V2SigTestsURL_BaseURL_SIGRender_hasToString";
   public final static String V2SIGTESTSURL_BASEURL_SIGRENDER_HASTOSTRINGRETURNS = "V2SigTestsURL_BaseURL_SIGRender_hasToStringReturns";
   public final static String V2SIGTESTSURL_BASEURL_SIGRENDER_HASWRITE = "V2SigTestsURL_BaseURL_SIGRender_hasWrite";
   public final static String V2SIGTESTSURL_BASEURL_SIGRENDER_HASWRITEA = "V2SigTestsURL_BaseURL_SIGRender_hasWriteA";
   public final static String V2SIGTESTSURL_BASEURL_SIGRENDER_HASWRITERETURNS = "V2SigTestsURL_BaseURL_SIGRender_hasWriteReturns";
   public final static String V2SIGTESTSURL_BASEURL_SIGRENDER_HASWRITERETURNSA = "V2SigTestsURL_BaseURL_SIGRender_hasWriteReturnsA";
   public final static String V2SIGTESTSURL_PORTLETURL_SIGRENDER_HASGETPORTLETMODE = "V2SigTestsURL_PortletURL_SIGRender_hasGetPortletMode";
   public final static String V2SIGTESTSURL_PORTLETURL_SIGRENDER_HASGETPORTLETMODERETURNS = "V2SigTestsURL_PortletURL_SIGRender_hasGetPortletModeReturns";
   public final static String V2SIGTESTSURL_PORTLETURL_SIGRENDER_HASGETWINDOWSTATE = "V2SigTestsURL_PortletURL_SIGRender_hasGetWindowState";
   public final static String V2SIGTESTSURL_PORTLETURL_SIGRENDER_HASGETWINDOWSTATERETURNS = "V2SigTestsURL_PortletURL_SIGRender_hasGetWindowStateReturns";
   public final static String V2SIGTESTSURL_PORTLETURL_SIGRENDER_HASREMOVEPUBLICRENDERPARAMETER = "V2SigTestsURL_PortletURL_SIGRender_hasRemovePublicRenderParameter";
   public final static String V2SIGTESTSURL_PORTLETURL_SIGRENDER_HASREMOVEPUBLICRENDERPARAMETERRETURNS = "V2SigTestsURL_PortletURL_SIGRender_hasRemovePublicRenderParameterReturns";
   public final static String V2SIGTESTSURL_PORTLETURL_SIGRENDER_HASSETPORTLETMODE = "V2SigTestsURL_PortletURL_SIGRender_hasSetPortletMode";
   public final static String V2SIGTESTSURL_PORTLETURL_SIGRENDER_HASSETPORTLETMODERETURNS = "V2SigTestsURL_PortletURL_SIGRender_hasSetPortletModeReturns";
   public final static String V2SIGTESTSURL_PORTLETURL_SIGRENDER_HASSETWINDOWSTATE = "V2SigTestsURL_PortletURL_SIGRender_hasSetWindowState";
   public final static String V2SIGTESTSURL_PORTLETURL_SIGRENDER_HASSETWINDOWSTATERETURNS = "V2SigTestsURL_PortletURL_SIGRender_hasSetWindowStateReturns";
   public final static String V2SIGTESTSURL_PORTLETURL_SIGRENDER_IMPLEMENTSBASEURL = "V2SigTestsURL_PortletURL_SIGRender_implementsBaseURL";
   ...
   static {
      ...
      tcd.put(V2SIGTESTSURL_BASEURL_SIGRENDER_HASADDPROPERTY, "BaseURL has a addProperty(String, String)  method ");
      tcd.put(V2SIGTESTSURL_BASEURL_SIGRENDER_HASADDPROPERTYRETURNS, "BaseURL method addProperty(String, String) returns void ");
      tcd.put(V2SIGTESTSURL_BASEURL_SIGRENDER_HASGETPARAMETERMAP, "BaseURL has a getParameterMap()  method ");
      tcd.put(V2SIGTESTSURL_BASEURL_SIGRENDER_HASGETPARAMETERMAPRETURNS, "BaseURL method getParameterMap() returns java.util.Map ");
      tcd.put(V2SIGTESTSURL_BASEURL_SIGRENDER_HASSETPARAMETER, "BaseURL has a setParameter(String, String)  method ");
      tcd.put(V2SIGTESTSURL_BASEURL_SIGRENDER_HASSETPARAMETERA, "BaseURL has a setParameter(String, String[])  method ");
      tcd.put(V2SIGTESTSURL_BASEURL_SIGRENDER_HASSETPARAMETERRETURNS, "BaseURL method setParameter(String, String) returns void ");
      tcd.put(V2SIGTESTSURL_BASEURL_SIGRENDER_HASSETPARAMETERRETURNSA, "BaseURL method setParameter(String, String[]) returns void ");
      tcd.put(V2SIGTESTSURL_BASEURL_SIGRENDER_HASSETPARAMETERS, "BaseURL has a setParameters(java.util.Map)  method ");
      tcd.put(V2SIGTESTSURL_BASEURL_SIGRENDER_HASSETPARAMETERSRETURNS, "BaseURL method setParameters(java.util.Map) returns void ");
      tcd.put(V2SIGTESTSURL_BASEURL_SIGRENDER_HASSETPROPERTY, "BaseURL has a setProperty(String, String)  method ");
      tcd.put(V2SIGTESTSURL_BASEURL_SIGRENDER_HASSETPROPERTYRETURNS, "BaseURL method setProperty(String, String) returns void ");
      tcd.put(V2SIGTESTSURL_BASEURL_SIGRENDER_HASSETSECURE, "BaseURL has a setSecure(boolean) throws PortletSecurityException method ");
      tcd.put(V2SIGTESTSURL_BASEURL_SIGRENDER_HASSETSECURERETURNS, "BaseURL method setSecure(boolean) returns void ");
      tcd.put(V2SIGTESTSURL_BASEURL_SIGRENDER_HASTOSTRING, "BaseURL has a toString()  method ");
      tcd.put(V2SIGTESTSURL_BASEURL_SIGRENDER_HASTOSTRINGRETURNS, "BaseURL method toString() returns String ");
      tcd.put(V2SIGTESTSURL_BASEURL_SIGRENDER_HASWRITE, "BaseURL has a write(java.io.Writer) throws java.io.IOException method ");
      tcd.put(V2SIGTESTSURL_BASEURL_SIGRENDER_HASWRITEA, "BaseURL has a write(java.io.Writer, boolean) throws java.io.IOException method ");
      tcd.put(V2SIGTESTSURL_BASEURL_SIGRENDER_HASWRITERETURNS, "BaseURL method write(java.io.Writer) returns void ");
      tcd.put(V2SIGTESTSURL_BASEURL_SIGRENDER_HASWRITERETURNSA, "BaseURL method write(java.io.Writer, boolean) returns void ");
      tcd.put(V2SIGTESTSURL_PORTLETURL_SIGRENDER_HASGETPORTLETMODE, "PortletURL has a getPortletMode()  method ");
      tcd.put(V2SIGTESTSURL_PORTLETURL_SIGRENDER_HASGETPORTLETMODERETURNS, "PortletURL method getPortletMode() returns PortletMode ");
      tcd.put(V2SIGTESTSURL_PORTLETURL_SIGRENDER_HASGETWINDOWSTATE, "PortletURL has a getWindowState()  method ");
      tcd.put(V2SIGTESTSURL_PORTLETURL_SIGRENDER_HASGETWINDOWSTATERETURNS, "PortletURL method getWindowState() returns WindowState ");
      tcd.put(V2SIGTESTSURL_PORTLETURL_SIGRENDER_HASREMOVEPUBLICRENDERPARAMETER, "PortletURL has a removePublicRenderParameter(String)  method ");
      tcd.put(V2SIGTESTSURL_PORTLETURL_SIGRENDER_HASREMOVEPUBLICRENDERPARAMETERRETURNS, "PortletURL method removePublicRenderParameter(String) returns void ");
      tcd.put(V2SIGTESTSURL_PORTLETURL_SIGRENDER_HASSETPORTLETMODE, "PortletURL has a setPortletMode(PortletMode) throws PortletModeException method ");
      tcd.put(V2SIGTESTSURL_PORTLETURL_SIGRENDER_HASSETPORTLETMODERETURNS, "PortletURL method setPortletMode(PortletMode) returns void ");
      tcd.put(V2SIGTESTSURL_PORTLETURL_SIGRENDER_HASSETWINDOWSTATE, "PortletURL has a setWindowState(WindowState) throws WindowStateException method ");
      tcd.put(V2SIGTESTSURL_PORTLETURL_SIGRENDER_HASSETWINDOWSTATERETURNS, "PortletURL method setWindowState(WindowState) returns void ");
      tcd.put(V2SIGTESTSURL_PORTLETURL_SIGRENDER_IMPLEMENTSBASEURL, "PortletURL implements BaseURL ");
