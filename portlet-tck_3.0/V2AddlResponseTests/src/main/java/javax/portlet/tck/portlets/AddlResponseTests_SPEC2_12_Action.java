...
public class AddlResponseTests_SPEC2_12_Action
  ...
  public void render(RenderRequest portletReq, RenderResponse portletResp)
    ...
    String msg = (String) ps.getAttribute(RESULT_ATTR_PREFIX + "AddlResponseTests_SPEC2_12_Action",
        APPLICATION_SCOPE)
        + (String) ps.getAttribute(RESULT_ATTR_PREFIX + "AddlResponseTests_SPEC2_12_Action_event",
            APPLICATION_SCOPE);
    if (msg != null && !msg.equals("nullnull") && !msg.equals("null")) {
      ...
      ps.removeAttribute(RESULT_ATTR_PREFIX + "AddlResponseTests_SPEC2_12_Action",
          APPLICATION_SCOPE);
      ps.removeAttribute(RESULT_ATTR_PREFIX + "AddlResponseTests_SPEC2_12_Action_event",
          APPLICATION_SCOPE);
    }
    ...
    if (portletReq.getParameter("tr1") != null && portletReq.getParameter("tr1").equals("true")) {
      ...
      writer.write(
          "         document.getElementById(\"AddlResponseTests_SPEC2_11_Action\").innerHTML=xhr.responseText;\n");
      writer.write("      }\n");
      writer.write("   };\n");
    ...
    if (portletReq.getParameter("tr5") != null) {
      ...
      tr5.appendTcDetail(portletReq.getParameter("tr5"));
      tr5.writeTo(writer);
    } else {
      PortletURL aurl = portletResp.createActionURL();
      aurl.setParameters(portletReq.getPrivateParameterMap());
    ...
    if (portletReq.getParameter("tckPRP1") != null) {
      ...
      tr6.appendTcDetail(portletReq.getParameter("tckPRP1"));
      tr6.writeTo(writer);
    } else {
      PortletURL aurl = portletResp.createActionURL();
      aurl.setParameters(portletReq.getPrivateParameterMap());
