...
public class DispatcherReqRespTests5S_SPEC2_19_ForwardServletActionRequest_servlet extends HttpServlet {
   private static final String LOG_CLASS = 
         DispatcherReqRespTests5S_SPEC2_19_ForwardServletActionRequest_servlet.class.getName();
   ...
   protected void processTCKReq(HttpServletRequest request, HttpServletResponse response)
      ...
      TestResult tr0 = tcd.getTestResultFailed(V2DISPATCHERREQRESPTESTS5S_SPEC2_19_FORWARDSERVLETACTIONREQUEST_GETINPUTSTREAM);
      /* TODO: implement test */
      ...
      TestResult tr1 = tcd.getTestResultFailed(V2DISPATCHERREQRESPTESTS5S_SPEC2_19_FORWARDSERVLETACTIONREQUEST_SETCHARACTERENCODING);
      /* TODO: implement test */
