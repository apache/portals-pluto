...
@PortletApplication(events = {
      ...
      @EventDefinition(
            qname=@PortletQName(namespaceURI="http://www.apache.org/", localPart="prpevent"),
            payloadType=String.class)
      }, publicParams = {
      @PublicRenderParameterDefinition(
            qname=@PortletQName(namespaceURI="http://www.apache.org/", localPart="prptestcase"),
            identifier = "prptestcase"
            )
})
