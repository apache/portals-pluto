...
public class PortletTests_Event_ApiEvent_event implements Portlet, EventPortlet, ResourceServingPortlet {
   private static final String LOG_CLASS     = PortletTests_Event_ApiEvent_event.class.getName();
   ...
   public void processEvent(EventRequest portletReq, EventResponse portletResp) throws PortletException, IOException {
      ...
      if (eventName.equals("PortletTests_Event_ApiEvent_localPart")) {
         ...
         TestResult tr12 = tcd_spec
               .getTestResultFailed(V2ADDLPORTLETTESTS_SPEC2_15_EVENTEVENTHANDLING_EVENTPROCESSEVENT4);
         if (evt.getQName().getNamespaceURI().equals("https://www.apache.org")) {
      ...
      String msg = (String) portletReq.getPortletSession().getAttribute(
            RESULT_ATTR_PREFIX + "PortletTests_Event_ApiEvent", APPLICATION_SCOPE);
      msg = msg + writer.toString();
      portletReq.getPortletSession().setAttribute(Constants.RESULT_ATTR_PREFIX + "PortletTests_Event_ApiEvent", msg,
            APPLICATION_SCOPE);
   }
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp) throws PortletException, IOException {
      ...
      String msg = (String) portletReq.getPortletSession().getAttribute(
            RESULT_ATTR_PREFIX + "PortletTests_Event_ApiEvent", APPLICATION_SCOPE);
      portletReq.getPortletSession().removeAttribute(RESULT_ATTR_PREFIX + "PortletTests_Event_ApiEvent",
            APPLICATION_SCOPE);
      ...
      /* namespace" */
      TestResult tr6 = tcd_spec.getTestResultFailed(V2ADDLPORTLETTESTS_SPEC2_6_RENDERCONFIG_GETPROCESSINGEVENTQNAMES3);
