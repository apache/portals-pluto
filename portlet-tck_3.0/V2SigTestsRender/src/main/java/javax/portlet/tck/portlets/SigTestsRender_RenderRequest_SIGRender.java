 ...
 * portlet SigTestsRender_RenderRequest_SIGRender_event
 *
 */
public class SigTestsRender_RenderRequest_SIGRender implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsRender_RenderRequest_SIGRender.class.getName();
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2SIGTESTSRENDER_RENDERREQUEST_SIGRENDER_HASGETETAGRETURNS);
      try {
         String name = "getETag";
      ...
      TestResult tr3 = tcd.getTestResultFailed(V2SIGTESTSRENDER_RENDERREQUEST_SIGRENDER_IMPLEMENTSPORTLETREQUEST);
      try {
