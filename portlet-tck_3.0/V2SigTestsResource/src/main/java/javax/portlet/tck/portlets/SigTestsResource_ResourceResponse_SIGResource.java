 ...
 * portlet SigTestsResource_ResourceResponse_SIGResource_event
 *
 */
public class SigTestsResource_ResourceResponse_SIGResource implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsResource_ResourceResponse_SIGResource.class.getName();
   ...
   public void serveResource(ResourceRequest portletReq, ResourceResponse portletResp)
      ...
      TestResult tr0 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCERESPONSE_SIGRESOURCE_FIELDHTTP_STATUS_CODE);
      try {
      ...
      /* PortletURL "                                                         */
      TestResult tr2 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCERESPONSE_SIGRESOURCE_HASCREATEACTIONURLRETURNS);
      try {
         String name = "createActionURL";
      ...
      /* PortletURL "                                                         */
      TestResult tr4 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCERESPONSE_SIGRESOURCE_HASCREATERENDERURLRETURNS);
      try {
         String name = "createRenderURL";
         Class<?> retType = PortletURL.class;
         Class<?>[] parms = null;
      ...
      /* ResourceURL "                                                        */
      TestResult tr6 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCERESPONSE_SIGRESOURCE_HASCREATERESOURCEURLRETURNS);
      try {
         String name = "createResourceURL";
      ...
      /* method "                                                             */
      TestResult tr7 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCERESPONSE_SIGRESOURCE_HASSETCHARACTERENCODING);
      try {
      ...
      /* returns void "                                                       */
      TestResult tr8 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCERESPONSE_SIGRESOURCE_HASSETCHARACTERENCODINGRETURNS);
      try {
         String name = "setCharacterEncoding";
      ...
      TestResult tr9 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCERESPONSE_SIGRESOURCE_HASSETCONTENTLENGTH);
      try {
      ...
      /* void "                                                               */
      TestResult tr10 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCERESPONSE_SIGRESOURCE_HASSETCONTENTLENGTHRETURNS);
      try {
         String name = "setContentLength";
         Class<?> retType = void.class;
         Class<?>[] parms = {int.class};
      ...
      /* method "                                                             */
      TestResult tr11 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCERESPONSE_SIGRESOURCE_HASSETLOCALE);
      try {
      ...
      /* returns void "                                                       */
      TestResult tr12 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCERESPONSE_SIGRESOURCE_HASSETLOCALERETURNS);
      try {
         String name = "setLocale";
         Class<?> retType = void.class;
         Class<?>[] parms = {java.util.Locale.class};
      ...
      TestResult tr13 = tcd.getTestResultFailed(V2SIGTESTSRESOURCE_RESOURCERESPONSE_SIGRESOURCE_IMPLEMENTSMIMERESPONSE);
      try {
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      writer.write("<div id=\"SigTestsResource_ResourceResponse_SIGResource\">no resource output.</div>\n");
      ...
      writer.write("         document.getElementById(\"SigTestsResource_ResourceResponse_SIGResource\").innerHTML=xhr.responseText;\n");
      writer.write("      }\n");
      writer.write("   };\n");
