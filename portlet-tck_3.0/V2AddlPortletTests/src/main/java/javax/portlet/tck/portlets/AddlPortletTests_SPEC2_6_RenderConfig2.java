 ...
 * portlet AddlPortletTests_SPEC2_6_RenderConfig2_event
 *
 */
public class AddlPortletTests_SPEC2_6_RenderConfig2 implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         AddlPortletTests_SPEC2_6_RenderConfig2.class.getName();
