...
/** 
 * The <CODE>StateAwareResponse</CODE> represents a response
 * that can modify state information or send events.<BR>
...
public interface StateAwareResponse extends PortletResponse {
     ...
     * <p>
     * The object type of the value must be compliant with the specified
     * event type in the portlet deployment descriptor.
     * <p>
     * The value must have a valid JAXB binding and be serializable.
     *   
     * @param  name    the event name to publish, must not be <code>null</code>
     * @param  value   the value of this event, must not be <code>null</code> and
     *                 must have a valid JAXB binding and be serializable.
     *
     * @exception   java.lang.IllegalArgumentException  
     *                      if name or value is <code>null</code>,
     *                      the value is not serializable,
     *                      the value has not a valid JAXB binding,
     *                      the object type of the value is not the same as specified
     ...
     * <p>
     * The events map must contain <code>String, Object</code> value pairs.
     * The <code>String</code> value represents the event name and the <code>Object</code>
     * value represents the event payload. The object types of the payload values must be 
     * compliant with the specified event types for the event types in the portlet deployment descriptor.
     * <p>
     * The values must have a valid JAXB binding and be serializable.
     * <p>
     * The order of the events in the map does not imply the order of the delivery
     * of the events.
     * 
     * @param  events    the events to publish, must not be <code>null</code>
     *
     * @exception   java.lang.IllegalArgumentException  
     *                      if events is <code>null</code>,
     *                      a name or payload in events is <code>null</code>,
     *                      a payload in events is not serializable,
     *                      a payload in events has not a valid JAXB binding,
     *                      the object type of a payload is not the same as specified
     *                      in the portlet deployment descriptor for this event name.
