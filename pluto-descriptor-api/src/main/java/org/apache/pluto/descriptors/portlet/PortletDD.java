 ...
 *         &lt;element name="supported-shared-render-parameter" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class PortletDD {
	...
	@XmlElement(name = "supported-shared-render-parameter")
