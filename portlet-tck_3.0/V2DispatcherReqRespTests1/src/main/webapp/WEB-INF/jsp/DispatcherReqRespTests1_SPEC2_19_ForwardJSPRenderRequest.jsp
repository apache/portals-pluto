...
<%
      ...
      try {
         String ha = (String)request.getAttribute(ATTR_PREFIX + "V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_getAttribute");
         String pa = (String)portletReq.getAttribute(ATTR_PREFIX + "V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_getAttribute");
      ...
      // TestLink for: DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest
      {
         String val = portletReq.getParameter(PARM_PREFIX + "V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_getParameter");
         if (val == null) {
            PortletURL rurl = ((RenderResponse)portletResp).createRenderURL();
            rurl.setParameter(PARM_PREFIX + "V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_getParameter", "Value");
            TestLink tl = new TestLink("V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_getParameter", rurl);
            tl.writeTo(writer);
         }
      }
      ...
      try {
         ...
         String val = portletReq.getParameter(PARM_PREFIX + "V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_getParameter");
         if (val != null) {
            String hval = request.getParameter(PARM_PREFIX + "V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_getParameter");
            String pval = portletReq.getParameter(PARM_PREFIX + "V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_getParameter");
      ...
      // TestLink for: DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest
      {
         String val = portletReq.getParameter(PARM_PREFIX + "V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_getParameterMap");
         if (val == null) {
            PortletURL rurl = ((RenderResponse)portletResp).createRenderURL();
            rurl.setParameter(PARM_PREFIX + "V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_getParameterMap", "Value");
            TestLink tl = new TestLink("V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_getParameterMap", rurl);
            tl.writeTo(writer);
         }
      }
      ...
      // TestLink for: DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest
      {
         String val = portletReq.getParameter(PARM_PREFIX + "V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_getParameterNames");
         if (val == null) {
            PortletURL rurl = ((RenderResponse)portletResp).createRenderURL();
            rurl.setParameter(PARM_PREFIX + "V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_getParameterNames", "Value");
            TestLink tl = new TestLink("V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_getParameterNames", rurl);
            tl.writeTo(writer);
         }
      }
      ...
      // TestLink for: DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest
      {
         String val = portletReq.getParameter(PARM_PREFIX + "V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_getParameterValues");
         if (val == null) {
            PortletURL rurl = ((RenderResponse)portletResp).createRenderURL();
            rurl.setParameter(PARM_PREFIX + "V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_getParameterValues", "Value");
            TestLink tl = new TestLink("V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_getParameterValues", rurl);
            tl.writeTo(writer);
         }
      }
      ...
      try {
         ...
         String val = portletReq.getParameter(PARM_PREFIX + "V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_getParameterValues");
         if (val != null) {
            String[] hvals = request.getParameterValues(PARM_PREFIX + "V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_getParameterValues");
            String[] pvals = portletReq.getParameterValues(PARM_PREFIX + "V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_getParameterValues");
      ...
      /* TestCase: V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_isRequestedSessionIdFromCookie */
      /* Details: "In a target jsp of a forward in the Render phase, the      */
      ...
      TestResult tr44 = tcd.getTestResultFailed(V2DISPATCHERREQRESPTESTS1_SPEC2_19_FORWARDJSPRENDERREQUEST_ISREQUESTEDSESSIONIDFROMCOOKIE);
      /* TODO: implement test */
      tr44.appendTcDetail("Not implemented.");
      tr44.writeTo(writer);

      /* TestCase: V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_isRequestedSessionIdFromURL1 */
      /* Details: "In a target jsp of a forward in the Render phase, the      */
      /* method HttpServletRequest.isRequestedSessionIdFromURL must provide   */
      /* functionality as defined in the servlet specification"               */
      TestResult tr45 = tcd.getTestResultFailed(V2DISPATCHERREQRESPTESTS1_SPEC2_19_FORWARDJSPRENDERREQUEST_ISREQUESTEDSESSIONIDFROMURL1);
      /* TODO: implement test */
      tr45.appendTcDetail("Not implemented.");
      tr45.writeTo(writer);

      /* TestCase: V2DispatcherReqRespTests1_SPEC2_19_ForwardJSPRenderRequest_isRequestedSessionIdFromUrl */
      /* Details: "In a target jsp of a forward in the Render phase, the      */
      /* method HttpServletRequest.isRequestedSessionIdFromUrl must provide   */
      /* functionality as defined in the servlet specification"               */
      TestResult tr46 = tcd.getTestResultFailed(V2DISPATCHERREQRESPTESTS1_SPEC2_19_FORWARDJSPRENDERREQUEST_ISREQUESTEDSESSIONIDFROMURL);
      /* TODO: implement test */
      ...
      TestResult tr47 = tcd.getTestResultFailed(V2DISPATCHERREQRESPTESTS1_SPEC2_19_FORWARDJSPRENDERREQUEST_ISREQUESTEDSESSIONIDVALID);
      /* TODO: implement test */
      ...
      TestResult tr48 = tcd.getTestResultFailed(V2DISPATCHERREQRESPTESTS1_SPEC2_19_FORWARDJSPRENDERREQUEST_ISSECURE);
      /* TODO: implement test */
      ...
      TestResult tr49 = tcd.getTestResultFailed(V2DISPATCHERREQRESPTESTS1_SPEC2_19_FORWARDJSPRENDERREQUEST_ISUSERINROLE);
      /* TODO: implement test */
      ...
      TestResult tr50 = tcd.getTestResultFailed(V2DISPATCHERREQRESPTESTS1_SPEC2_19_FORWARDJSPRENDERREQUEST_REMOVEATTRIBUTE);
      /* TODO: implement test */
      ...
      TestResult tr51 = tcd.getTestResultFailed(V2DISPATCHERREQRESPTESTS1_SPEC2_19_FORWARDJSPRENDERREQUEST_SETATTRIBUTE);
      /* TODO: implement test */
      ...
      /* any operation"                                                       */
      TestResult tr52 = tcd.getTestResultFailed(V2DISPATCHERREQRESPTESTS1_SPEC2_19_FORWARDJSPRENDERREQUEST_SETCHARACTERENCODING);
      /* TODO: implement test */
