...
public class SigTestsAction_PortletRequest_SIGAction implements Portlet, ResourceServingPortlet {
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      /* Details: "ActionRequest has a getResponseContentType()  method "     */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasGetResponseContentType", aurl);
         tb.writeTo(writer);
      }
      ...
      /* String "                                                             */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasGetResponseContentTypeReturns", aurl);
         tb.writeTo(writer);
      }
      ...
      /* Details: "ActionRequest has a getResponseContentTypes()  method "    */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasGetResponseContentTypes", aurl);
         tb.writeTo(writer);
      }
      ...
      /* java.util.Enumeration "                                              */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasGetResponseContentTypesReturns", aurl);
         tb.writeTo(writer);
      }
      ...
      /* Details: "ActionRequest has a getScheme()  method "                  */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasGetScheme", aurl);
         tb.writeTo(writer);
      }
      ...
      /* Details: "ActionRequest method getScheme() returns String "          */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasGetSchemeReturns", aurl);
         tb.writeTo(writer);
      }
      ...
      /* Details: "ActionRequest has a getServerName()  method "              */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasGetServerName", aurl);
         tb.writeTo(writer);
      }
      ...
      /* Details: "ActionRequest method getServerName() returns String "      */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasGetServerNameReturns", aurl);
         tb.writeTo(writer);
      }
      ...
      /* Details: "ActionRequest has a getServerPort()  method "              */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasGetServerPort", aurl);
         tb.writeTo(writer);
      }
      ...
      /* Details: "ActionRequest method getServerPort() returns int "         */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasGetServerPortReturns", aurl);
         tb.writeTo(writer);
      }
      ...
      /* Details: "ActionRequest has a getUserPrincipal()  method "           */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasGetUserPrincipal", aurl);
         tb.writeTo(writer);
      }
      ...
      /* java.security.Principal "                                            */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasGetUserPrincipalReturns", aurl);
         tb.writeTo(writer);
      }
      ...
      /* Details: "ActionRequest has a getWindowID()  method "                */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasGetWindowID", aurl);
         tb.writeTo(writer);
      }
      ...
      /* Details: "ActionRequest method getWindowID() returns String "        */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasGetWindowIDReturns", aurl);
         tb.writeTo(writer);
      }
      ...
      /* Details: "ActionRequest has a getWindowState()  method "             */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasGetWindowState", aurl);
         tb.writeTo(writer);
      }
      ...
      /* WindowState "                                                        */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasGetWindowStateReturns", aurl);
         tb.writeTo(writer);
      }
      ...
      /* method "                                                             */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasIsPortletModeAllowed", aurl);
         tb.writeTo(writer);
      }
      ...
      /* returns boolean "                                                    */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasIsPortletModeAllowedReturns", aurl);
         tb.writeTo(writer);
      }
      ...
      /* "                                                                    */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasIsRequestedSessionIdValid", aurl);
         tb.writeTo(writer);
      }
      ...
      /* boolean "                                                            */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasIsRequestedSessionIdValidReturns", aurl);
         tb.writeTo(writer);
      }
      ...
      /* Details: "ActionRequest method isSecure() returns boolean "          */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasIsSecureReturns", aurl);
         tb.writeTo(writer);
      }
      ...
      /* Details: "ActionRequest has a isUserInRole(String)  method "         */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasIsUserInRole", aurl);
         tb.writeTo(writer);
      }
      ...
      /* boolean "                                                            */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasIsUserInRoleReturns", aurl);
         tb.writeTo(writer);
      }
      ...
      /* method "                                                             */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasIsWindowStateAllowed", aurl);
         tb.writeTo(writer);
      }
      ...
      /* returns boolean "                                                    */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasIsWindowStateAllowedReturns", aurl);
         tb.writeTo(writer);
      }
      ...
      /* Details: "ActionRequest has a removeAttribute(String)  method "      */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasRemoveAttribute", aurl);
         tb.writeTo(writer);
      }
      ...
      /* void "                                                               */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasRemoveAttributeReturns", aurl);
         tb.writeTo(writer);
      }
      ...
      /* "                                                                    */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasSetAttribute", aurl);
         tb.writeTo(writer);
      }
      ...
      /* returns void "                                                       */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2SigTestsAction_PortletRequest_SIGAction_hasSetAttributeReturns", aurl);
         tb.writeTo(writer);
      }
