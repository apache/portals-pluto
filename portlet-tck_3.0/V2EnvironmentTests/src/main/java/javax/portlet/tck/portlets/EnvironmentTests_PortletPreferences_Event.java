 ...
 * portlet EnvironmentTests_PortletPreferences_Event_event
 *
 */
public class EnvironmentTests_PortletPreferences_Event implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         EnvironmentTests_PortletPreferences_Event.class.getName();
   ...
   public void processAction(ActionRequest portletReq, ActionResponse portletResp)
      ...
      QName eventQName = new QName(TCKNAMESPACE,
             "EnvironmentTests_PortletPreferences_Event");
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      /* descriptor"                                                          */
      {
         ...
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_isReadOnly1", aurl);
         tb.writeTo(writer);
      }
      ...
      /* deployment descriptor"                                               */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_isReadOnly2", aurl);
         tb.writeTo(writer);
      }
      ...
      /* specified by the key is undefined"                                   */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_isReadOnly3", aurl);
         tb.writeTo(writer);
      }
      ...
      /* the key is null"                                                     */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_isReadOnly4", aurl);
         tb.writeTo(writer);
      }
      ...
      /* String value for the specified key"                                  */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_getValue1", aurl);
         tb.writeTo(writer);
      }
      ...
      /* default value if there is no value for the specified key "           */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_getValue2", aurl);
         tb.writeTo(writer);
      }
      ...
      /* "                                                                    */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_getValue3", aurl);
         tb.writeTo(writer);
      }
      ...
      /* IllegalArgumentException if the key is null"                         */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_getValue4", aurl);
         tb.writeTo(writer);
      }
      ...
      /* String[] for the specified key"                                      */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_getValues1", aurl);
         tb.writeTo(writer);
      }
      ...
      /* key "                                                                */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_getValues2", aurl);
         tb.writeTo(writer);
      }
      ...
      /* specified key is null "                                              */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_getValues3", aurl);
         tb.writeTo(writer);
      }
      ...
      /* IllegalArgumentException if the key is null"                         */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_getValues4", aurl);
         tb.writeTo(writer);
      }
      ...
      /* value for the specified key"                                         */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_setValue1", aurl);
         tb.writeTo(writer);
      }
      ...
      /* String[] value for the specified key is replaced"                    */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_setValue2", aurl);
         tb.writeTo(writer);
      }
      ...
      /* null"                                                                */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_setValue3", aurl);
         tb.writeTo(writer);
      }
      ...
      /* request"                                                             */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_setValue4", aurl);
         tb.writeTo(writer);
      }
      ...
      /* IllegalArgumentException if the key is null"                         */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_setValue5", aurl);
         tb.writeTo(writer);
      }
      ...
      /* value array for the specified key"                                   */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_setValues1", aurl);
         tb.writeTo(writer);
      }
      ...
      /* or String[] Values for the specified key is replaced"                */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_setValues2", aurl);
         tb.writeTo(writer);
      }
      ...
      /* be set to null"                                                      */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_setValues3", aurl);
         tb.writeTo(writer);
      }
      ...
      /* contain null members"                                                */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_setValues4", aurl);
         tb.writeTo(writer);
      }
      ...
      /* request"                                                             */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_setValues5", aurl);
         tb.writeTo(writer);
      }
      ...
      /* IllegalArgumentException if the key is null"                         */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_setValues6", aurl);
         tb.writeTo(writer);
      }
      ...
      /* available preference keys"                                           */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_getNames1", aurl);
         tb.writeTo(writer);
      }
      ...
      /* preference keys are available"                                       */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_getNames2", aurl);
         tb.writeTo(writer);
      }
      ...
      /* preferences"                                                         */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_getMap1", aurl);
         tb.writeTo(writer);
      }
      ...
      /* are available"                                                       */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_getMap2", aurl);
         tb.writeTo(writer);
      }
      ...
      /* specified key"                                                       */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_reset1", aurl);
         tb.writeTo(writer);
      }
      ...
      /* preference cannot be modified for this request"                      */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_reset2", aurl);
         tb.writeTo(writer);
      }
      ...
      /* key is null"                                                         */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_reset3", aurl);
         tb.writeTo(writer);
      }
      ...
      /* to the persistent store "                                            */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_store1", aurl);
         tb.writeTo(writer);
      }
      ...
      /* changes made are discarded"                                          */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_store2", aurl);
         tb.writeTo(writer);
      }
      ...
      /* before the actual store is performed"                                */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_store3", aurl);
         tb.writeTo(writer);
      }
      ...
      /* performed"                                                           */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_store4", aurl);
         tb.writeTo(writer);
      }
      ...
      /* is called in the render method  "                                    */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_store5", aurl);
         tb.writeTo(writer);
      }
      ...
      /* validation performed by the associated validator fails "             */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2EnvironmentTests_PortletPreferences_Event_store6", aurl);
         tb.writeTo(writer);
      }
