 ...
 */
public class EnvironmentTests_PortletPreferences_ApiEvent_event implements Portlet, EventPortlet, ResourceServingPortlet {
   ...
   public void processEvent(EventRequest portletReq, EventResponse portletResp)
      ...
      portletReq.getPortletSession().setAttribute(
                   Constants.RESULT_ATTR_PREFIX + "EnvironmentTests_PortletPreferences_ApiEvent",
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      String msg = (String) portletReq.getPortletSession()
            .getAttribute(RESULT_ATTR_PREFIX + "EnvironmentTests_PortletPreferences_ApiEvent", APPLICATION_SCOPE);
