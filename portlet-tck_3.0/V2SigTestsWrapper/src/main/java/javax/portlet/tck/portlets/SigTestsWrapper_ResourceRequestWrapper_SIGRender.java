 ...
 * portlet SigTestsWrapper_ResourceRequestWrapper_SIGRender_event
 *
 */
public class SigTestsWrapper_ResourceRequestWrapper_SIGRender implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsWrapper_ResourceRequestWrapper_SIGRender.class.getName();
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      TestResult tr0 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_CONSTRUCTOR);
      try {
      ...
      /* TestCase: V2SigTestsWrapper_ResourceRequestWrapper_SIGRender_extendsPortletRequestWrapper */
      /* Details: "ResourceRequestWrapper extends PortletRequestWrapper "     */
      TestResult tr1 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_EXTENDSPORTLETREQUESTWRAPPER);
      try {
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETCACHEABILITY);
      try {
      ...
      /* String "                                                             */
      TestResult tr3 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETCACHEABILITYRETURNS);
      try {
         String name = "getCacheability";
      ...
      /* method "                                                             */
      TestResult tr4 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETCHARACTERENCODING);
      try {
      ...
      /* returns String "                                                     */
      TestResult tr5 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETCHARACTERENCODINGRETURNS);
      try {
         String name = "getCharacterEncoding";
         Class<?> retType = String.class;
         Class<?>[] parms = null;
      ...
      /* "                                                                    */
      TestResult tr6 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETCONTENTLENGTH);
      try {
      ...
      /* int "                                                                */
      TestResult tr7 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETCONTENTLENGTHRETURNS);
      try {
         String name = "getContentLength";
      ...
      TestResult tr8 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETCONTENTTYPE);
      try {
      ...
      /* String "                                                             */
      TestResult tr9 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETCONTENTTYPERETURNS);
      try {
         String name = "getContentType";
         Class<?> retType = String.class;
         Class<?>[] parms = null;
      ...
      TestResult tr10 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETETAG);
      try {
         String name = "getETag";
         Class<?>[] exceptions = null;
         Class<?>[] parms = null;
      ...
      TestResult tr11 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETETAGRETURNS);
      try {
         String name = "getETag";
         Class<?> retType = String.class;
         Class<?>[] parms = null;
      ...
      TestResult tr12 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETMETHOD);
      try {
      ...
      /* "                                                                    */
      TestResult tr13 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETMETHODRETURNS);
      try {
         String name = "getMethod";
         Class<?> retType = String.class;
         Class<?>[] parms = null;
      ...
      TestResult tr14 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETPORTLETINPUTSTREAM);
      try {
      ...
      TestResult tr15 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETPORTLETINPUTSTREAMRETURNS);
      try {
         String name = "getPortletInputStream";
      ...
      TestResult tr16 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETPRIVATERENDERPARAMETERMAP);
      try {
      ...
      /* TestCase: V2SigTestsWrapper_ResourceRequestWrapper_SIGRender_hasGetPrivateRenderParameterMapReturns */
      /* Details: "ResourceRequestWrapper method                              */
      /* getPrivateRenderParameterMap() returns java.util.Map "               */
      TestResult tr17 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETPRIVATERENDERPARAMETERMAPRETURNS);
      try {
         String name = "getPrivateRenderParameterMap";
      ...
      TestResult tr18 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETREADER);
      try {
      ...
      TestResult tr19 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETREADERRETURNS);
      try {
         String name = "getReader";
      ...
      TestResult tr20 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETREQUEST);
      try {
      ...
      /* Details: "ResourceRequestWrapper has a getRequest()  method "        */
      TestResult tr21 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETREQUESTA);
      try {
         String name = "getRequest";
         Class<?>[] exceptions = null;
         Class<?>[] parms = null;
      ...
      /* ResourceRequest "                                                    */
      TestResult tr22 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETREQUESTRETURNS);
      try {
         String name = "getRequest";
      ...
      /* Details: "ResourceRequestWrapper method getRequest() returns         */
      /* PortletRequest "                                                     */
      TestResult tr23 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETREQUESTRETURNSA);
      try {
         String name = "getRequest";
      ...
      TestResult tr24 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETRESOURCEID);
      try {
      ...
      /* String "                                                             */
      TestResult tr25 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASGETRESOURCEIDRETURNS);
      try {
         String name = "getResourceID";
         Class<?> retType = String.class;
         Class<?>[] parms = null;
      ...
      TestResult tr26 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASSETCHARACTERENCODING);
      try {
      ...
      TestResult tr27 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASSETCHARACTERENCODINGRETURNS);
      try {
         String name = "setCharacterEncoding";
      ...
      /* method "                                                             */
      TestResult tr28 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASSETREQUEST);
      try {
      ...
      TestResult tr29 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_HASSETREQUESTRETURNS);
      try {
         String name = "setRequest";
         Class<?> retType = void.class;
         Class<?>[] parms = {ResourceRequest.class};
      ...
      TestResult tr30 = tcd.getTestResultFailed(V2SIGTESTSWRAPPER_RESOURCEREQUESTWRAPPER_SIGRENDER_IMPLEMENTSRESOURCEREQUEST);
      try {
