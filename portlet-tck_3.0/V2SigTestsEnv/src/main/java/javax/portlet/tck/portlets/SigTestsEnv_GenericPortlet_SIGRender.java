 ...
 * portlet SigTestsEnv_GenericPortlet_SIGRender_event
 *
 */
public class SigTestsEnv_GenericPortlet_SIGRender implements Portlet, ResourceServingPortlet {
   private static final String LOG_CLASS = 
         SigTestsEnv_GenericPortlet_SIGRender.class.getName();
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASDESTROYRETURNS);
      try {
         String name = "destroy";
      ...
      TestResult tr4 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASDODISPATCHRETURNS);
      try {
         String name = "doDispatch";
         Class<?> retType = void.class;
         Class<?>[] parms = {RenderRequest.class, RenderResponse.class};
      ...
      /* RenderResponse) returns void "                                       */
      TestResult tr6 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASDOEDITRETURNS);
      try {
         String name = "doEdit";
         Class<?> retType = void.class;
         Class<?>[] parms = {RenderRequest.class, RenderResponse.class};
      ...
      /* RenderResponse) returns void "                                       */
      TestResult tr8 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASDOHEADERSRETURNS);
      try {
         String name = "doHeaders";
         Class<?> retType = void.class;
         Class<?>[] parms = {RenderRequest.class, RenderResponse.class};
      ...
      /* RenderResponse) returns void "                                       */
      TestResult tr10 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASDOHELPRETURNS);
      try {
         String name = "doHelp";
         Class<?> retType = void.class;
         Class<?>[] parms = {RenderRequest.class, RenderResponse.class};
      ...
      /* RenderResponse) returns void "                                       */
      TestResult tr12 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASDOVIEWRETURNS);
      try {
         String name = "doView";
         Class<?> retType = void.class;
         Class<?>[] parms = {RenderRequest.class, RenderResponse.class};
      ...
      /* method "                                                             */
      TestResult tr13 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETCONTAINERRUNTIMEOPTIONS);
      try {
      ...
      TestResult tr14 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETCONTAINERRUNTIMEOPTIONSRETURNS);
      try {
         String name = "getContainerRuntimeOptions";
      ...
      TestResult tr15 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETDEFAULTNAMESPACE);
      try {
      ...
      /* String "                                                             */
      TestResult tr16 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETDEFAULTNAMESPACERETURNS);
      try {
         String name = "getDefaultNamespace";
      ...
      TestResult tr17 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETINITPARAMETER);
      try {
      ...
      TestResult tr18 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETINITPARAMETERNAMES);
      try {
      ...
      TestResult tr19 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETINITPARAMETERNAMESRETURNS);
      try {
         String name = "getInitParameterNames";
      ...
      /* String "                                                             */
      TestResult tr20 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETINITPARAMETERRETURNS);
      try {
         String name = "getInitParameter";
         Class<?> retType = String.class;
         Class<?>[] parms = {String.class};
      ...
      TestResult tr21 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETNEXTPOSSIBLEPORTLETMODES);
      try {
      ...
      TestResult tr22 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETNEXTPOSSIBLEPORTLETMODESRETURNS);
      try {
         String name = "getNextPossiblePortletModes";
      ...
      TestResult tr23 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETPORTLETCONFIG);
      try {
      ...
      /* PortletConfig "                                                      */
      TestResult tr24 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETPORTLETCONFIGRETURNS);
      try {
         String name = "getPortletConfig";
      ...
      TestResult tr25 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETPORTLETCONTEXT);
      try {
      ...
      /* PortletContext "                                                     */
      TestResult tr26 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETPORTLETCONTEXTRETURNS);
      try {
         String name = "getPortletContext";
      ...
      TestResult tr27 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETPORTLETNAME);
      try {
      ...
      TestResult tr28 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETPORTLETNAMERETURNS);
      try {
         String name = "getPortletName";
         Class<?> retType = String.class;
         Class<?>[] parms = null;
      ...
      /* "                                                                    */
      TestResult tr29 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETPROCESSINGEVENTQNAMES);
      try {
      ...
      /* java.util.Enumeration "                                              */
      TestResult tr30 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETPROCESSINGEVENTQNAMESRETURNS);
      try {
         String name = "getProcessingEventQNames";
         Class<?> retType = java.util.Enumeration.class;
         Class<?>[] parms = null;
      ...
      /* method "                                                             */
      TestResult tr31 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETPUBLICRENDERPARAMETERNAMES);
      try {
      ...
      TestResult tr32 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETPUBLICRENDERPARAMETERNAMESRETURNS);
      try {
         String name = "getPublicRenderParameterNames";
         Class<?> retType = java.util.Enumeration.class;
         Class<?>[] parms = null;
      ...
      /* "                                                                    */
      TestResult tr33 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETPUBLISHINGEVENTQNAMES);
      try {
      ...
      /* java.util.Enumeration "                                              */
      TestResult tr34 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETPUBLISHINGEVENTQNAMESRETURNS);
      try {
         String name = "getPublishingEventQNames";
         Class<?> retType = java.util.Enumeration.class;
         Class<?>[] parms = null;
      ...
      /* method "                                                             */
      TestResult tr35 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETRESOURCEBUNDLE);
      try {
      ...
      TestResult tr36 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETRESOURCEBUNDLERETURNS);
      try {
         String name = "getResourceBundle";
      ...
      TestResult tr37 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETSUPPORTEDLOCALES);
      try {
      ...
      /* java.util.Enumeration "                                              */
      TestResult tr38 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETSUPPORTEDLOCALESRETURNS);
      try {
         String name = "getSupportedLocales";
         Class<?> retType = java.util.Enumeration.class;
         Class<?>[] parms = null;
      ...
      /* String "                                                             */
      TestResult tr40 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASGETTITLERETURNS);
      try {
         String name = "getTitle";
         Class<?> retType = String.class;
         Class<?>[] parms = {RenderRequest.class};
      ...
      TestResult tr43 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASINITRETURNS);
      try {
         String name = "init";
         Class<?> retType = void.class;
         Class<?>[] parms = {PortletConfig.class};
      ...
      TestResult tr44 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASINITRETURNSA);
      try {
         String name = "init";
         Class<?> retType = void.class;
         Class<?>[] parms = null;
      ...
      /* method "                                                             */
      TestResult tr45 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASPROCESSACTION);
      try {
      ...
      TestResult tr46 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASPROCESSACTIONRETURNS);
      try {
         String name = "processAction";
         Class<?> retType = void.class;
         Class<?>[] parms = {ActionRequest.class, ActionResponse.class};
      ...
      /* "                                                                    */
      TestResult tr47 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASPROCESSEVENT);
      try {
      ...
      TestResult tr48 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASPROCESSEVENTRETURNS);
      try {
         String name = "processEvent";
         Class<?> retType = void.class;
         Class<?>[] parms = {EventRequest.class, EventResponse.class};
      ...
      /* RenderResponse) returns void "                                       */
      TestResult tr50 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASRENDERRETURNS);
      try {
         String name = "render";
         Class<?> retType = void.class;
         Class<?>[] parms = {RenderRequest.class, RenderResponse.class};
      ...
      /* method "                                                             */
      TestResult tr51 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASSERVERESOURCE);
      try {
      ...
      TestResult tr52 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_HASSERVERESOURCERETURNS);
      try {
         String name = "serveResource";
         Class<?> retType = void.class;
         Class<?>[] parms = {ResourceRequest.class, ResourceResponse.class};
      ...
      TestResult tr53 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_IMPLEMENTSEVENTPORTLET);
      try {
      ...
      TestResult tr54 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_IMPLEMENTSPORTLET);
      try {
      ...
      TestResult tr55 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_IMPLEMENTSPORTLETCONFIG);
      try {
      ...
      TestResult tr56 = tcd.getTestResultFailed(V2SIGTESTSENV_GENERICPORTLET_SIGRENDER_IMPLEMENTSRESOURCESERVINGPORTLET);
      try {
