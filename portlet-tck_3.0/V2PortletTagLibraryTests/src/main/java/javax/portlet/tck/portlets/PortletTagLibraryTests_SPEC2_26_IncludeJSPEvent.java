...
public class PortletTagLibraryTests_SPEC2_26_IncludeJSPEvent implements Portlet, ResourceServingPortlet {
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      /* undefined"                                                           */
      {
         ...
         TestButton tb = new TestButton("V2PortletTagLibraryTests_SPEC2_26_IncludeJSPEvent_defineObjects1", aurl);
         tb.writeTo(writer);
      }
      ...
      /* undefined"                                                           */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2PortletTagLibraryTests_SPEC2_26_IncludeJSPEvent_defineObjects2", aurl);
         tb.writeTo(writer);
      }
      ...
      /* undefined"                                                           */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2PortletTagLibraryTests_SPEC2_26_IncludeJSPEvent_defineObjects3", aurl);
         tb.writeTo(writer);
      }
      ...
      /* corresponding object"                                                */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2PortletTagLibraryTests_SPEC2_26_IncludeJSPEvent_defineObjects4", aurl);
         tb.writeTo(writer);
      }
      ...
      /* undefined"                                                           */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2PortletTagLibraryTests_SPEC2_26_IncludeJSPEvent_defineObjects5", aurl);
         tb.writeTo(writer);
      }
      ...
      /* or undefined"                                                        */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2PortletTagLibraryTests_SPEC2_26_IncludeJSPEvent_defineObjects6", aurl);
         tb.writeTo(writer);
      }
      ...
      /* undefined"                                                           */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2PortletTagLibraryTests_SPEC2_26_IncludeJSPEvent_defineObjects7", aurl);
         tb.writeTo(writer);
      }
      ...
      /* corresponding object"                                                */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2PortletTagLibraryTests_SPEC2_26_IncludeJSPEvent_defineObjects8", aurl);
         tb.writeTo(writer);
      }
      ...
      /* defines the variable PortletConfig portletConfig"                    */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2PortletTagLibraryTests_SPEC2_26_IncludeJSPEvent_defineObjects9", aurl);
         tb.writeTo(writer);
      }
      ...
      /* returns an existing session or null if no session exists."           */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2PortletTagLibraryTests_SPEC2_26_IncludeJSPEvent_defineObjects10", aurl);
         tb.writeTo(writer);
      }
      ...
      /* session attributes exist this method returns an empty Map."          */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2PortletTagLibraryTests_SPEC2_26_IncludeJSPEvent_defineObjects11", aurl);
         tb.writeTo(writer);
      }
      ...
      /* providing access to the portlet preferences."                        */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2PortletTagLibraryTests_SPEC2_26_IncludeJSPEvent_defineObjects12", aurl);
         tb.writeTo(writer);
      }
      ...
      /* the Map is empty."                                                   */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton("V2PortletTagLibraryTests_SPEC2_26_IncludeJSPEvent_defineObjects13", aurl);
         tb.writeTo(writer);
      }
