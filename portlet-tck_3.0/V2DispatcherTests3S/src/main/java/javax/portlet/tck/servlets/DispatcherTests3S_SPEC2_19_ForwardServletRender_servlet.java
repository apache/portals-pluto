 ...
 * Used by portlet: DispatcherTests3S_SPEC2_19_ForwardServletRender
 *
 * @author nick
 *
 */
public class DispatcherTests3S_SPEC2_19_ForwardServletRender_servlet extends HttpServlet {
   private static final String LOG_CLASS = 
         DispatcherTests3S_SPEC2_19_ForwardServletRender_servlet.class.getName();
   ...
   protected void processTCKReq(HttpServletRequest request, HttpServletResponse response)
      ...
      /* TestCase: V2DispatcherTests3S_SPEC2_19_ForwardServletRender_dispatch4 */
      ...
      /* TestCase: V2DispatcherTests3S_SPEC2_19_ForwardServletRender_invoke3  */
      /* Details: "Parameters to the forward method for a target servlet      */
      /* can be wrapped request and response classes from the portlet         */
      /* lifecyle method initiating the include"                              */
      TestResult tr1 = tcd.getTestResultFailed(V2DISPATCHERTESTS3S_SPEC2_19_FORWARDSERVLETRENDER_INVOKE3);
      /* TODO: implement test */
